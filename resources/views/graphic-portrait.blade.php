    ...
    <section class="gift-card">
        ...
        <div class="gift-card-content">
            <div class="card clearfix">
                <div class="card-item">
                    <img src="{{ asset('img/front_') . app()->getLocale() . '.png' }}"  @frontendAlt('graphic-portrait.blade.php', (asset('img/front_') . app()->getLocale() . '.png'), '', '')>
                </div>
                <div class="card-item">
                    <img src="{{ asset('img/back_') . app()->getLocale() . '.png' }}"  @frontendAlt('graphic-portrait.blade.php', (asset('img/back_') . app()->getLocale() . '.png'), '', '')>
                </div>
            </div>
