        ...
        <table class="main" width="100%">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 540px;">
                        <tr>
                            <td align="center" valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;max-width: 257px;display: inline-block;vertical-align: top;">
                                    <tr>
                                        <td align="left" valign="top" width="237">
                                            <img src="https://viarcanvas.com/letters/new/Logo.png" width="237" height="86" style="margin:0; padding:0; border:none; display:inline-block;" border="0" alt="logo" />
                                        </td>
                                    </tr>
                                </table>
                                <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;max-width: 257px;display: inline-block;">
                                    <tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle" style="padding-left: 10px;">
                                                        <a style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 30px;
												line-height: 34px;color: #1E2533;white-space: nowrap;" href="@lang('mail.setting_phone_href')">@lang('mail.setting_phone')</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            <tr>
                <td align="left" valign="top" bgcolor="#F7E2E3" style="padding-left: 10px;padding-right: 10px;">
                    ...
                    <span style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 30px;line-height: 34px;
						color: #1E2533;">@lang('mail.mail_your_order_received_title_number')2386</span>
        ...
        <table class="main" width="100%">
            ...
            <tr>
                <td class="desktop" align="center" valign="top" width="280" bgcolor="#F7E2E3" style="padding-left: 10px;padding-right: 10px;">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #fa7846;padding: 10px;">
                                    ...
                                    <tr>
                                        <td align="left" valign="middle">
                                            <img src="https://viarcanvas.com/letters/new/check-circle.png" width="20" height="20" style="margin:0; padding:0; border:none; display:inline-block;vertical-align: bottom;padding-right: 6px;" border="0" alt="check-circle" />
                                            <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;line-height: 17px;color: #1E2533;">Шарж</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" valign="middle">
                                            <img src="https://viarcanvas.com/letters/new/check-circle.png" width="20" height="20" style="margin:0; padding:0; border:none; display:inline-block;vertical-align: bottom;padding-right: 6px;" border="0" alt="check-circle" />
                                            <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
									  line-height: 17px;color: #1E2533;">Размер: <strong>100*70</strong></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="17" style="font-size:0; line-height:0;">&nbsp;</td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Тип исполненния: <strong>Печать на холсте</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Упаковка:  <strong>Подарочная</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Изготовление: <strong>Стандарт - 3 рабочих дня</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Планируемая дата доставки: <strong>26.03.2022</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Доставка:  <strong>Курьером по адресу г.Рига, Бульвар Калпака 12, дом 2, кв.,26</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Цена:   <strong>15€</strong></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td align="center" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;
												  line-height: 17px;color: #1E2533;">Ваш комментарий:  </span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;max-width: 212px;display: inline-block;background: url('https://viarcanvas.com/letters/new/box-r.png');background-position: center;background-repeat: no-repeat;background-size: cover;width: 212px;height: 473px;">
                        <tr>
                            <td align="right" valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="right" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%" style="padding-left: 125px;">
                                                <tr>
                                                    <td height="20" style="font-size:0; line-height:0;">&nbsp;</td>
                                                </tr>
                                                <tr>
            ...
            <!-- gift mobile -->
            <tr>
                <td class="mobile" align="center" valign="top" width="280" bgcolor="#F7E2E3" style="padding-left: 10px;padding-right: 10px;padding-bottom: 29px;">
                    <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;max-width: 332px;background: #ffffff;padding: 9px;display: inline-block;vertical-align: top;">
                        <tr>
                            <td align="center" valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #fa7846;padding: 10px;">
            ...
            <tr>
                <td class="mobile" align="center" valign="top" bgcolor="#f7e2e3">
                    <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%;max-width: 204px;display: inline-block;background: url('https://viarcanvas.com/letters/new/gift-mobile.png');background-position: center;background-repeat: no-repeat;background-size: cover;width: 204px;height: 123px;">
                        <tr>
                            <td align="right" valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td align="left" valign="top" bgcolor="#F7E2E3">
                                <table cellpadding="0" cellspacing="0" width="100%" style="background: url('https://viarcanvas.com/letters/new/badge-bg.png');background-position: center;background-repeat: no-repeat;background-size: cover;width: 155px;height: 140px;display: inline-block;">
                                    <tr>
        ...
        <table class="main" width="100%">
                            ...
                            <td align="center" valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                                    <tr>
                                        ...
                                        <td align="left" valign="middle" style="padding-left: 10px;">
                                            <a style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 30px;
									line-height: 34px;color: #FA7846 !important;white-space: nowrap;" href="@lang('mail.setting_phone_href')">@lang('mail.setting_phone')</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table style="border-spacing:0;text-align:left;">
                                                                        <tr>
                                                                            <td align="center" valign="top">
                                                                                <img src="https://viarcanvas.com/letters/new/sharj.png" width="270" height="347" style="margin:0; padding:0; border:none; display:inline-block;" border="0" alt="Sharj" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="15" style="font-size:0; line-height:0;">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top">
                                                                                <span style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 20px;line-height: 23px;color: #1E2533;">15€</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table style="border-spacing:0;text-align:left;">
                                                                        <tr>
                                                                            <td align="center" valign="top">
                                                                                <img src="https://viarcanvas.com/letters/new/art.png" width="270" height="347" style="margin:0; padding:0; border:none; display:inline-block;border-radius: 8px;" border="0" alt="Art" />
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top">
                                                                                <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;line-height: 135%;text-align: center;color: #110F0F;">@lang('mail.mail_your_order_received_top_footer_name_2')</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="15" style="font-size:0; line-height:0;">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top">
                                                                                <table align="center" border="0" cellpadding="0" style="border-spacing:0px;">
                                                                                    <tr>
                                                                                        <td style="border-radius: 8px;" bgcolor="#eff8fe">
                                                                                            <a href="https://viarcanvas.com/" target="_blank" style="font-size: 16px; font-weight: bold;text-decoration:none;color:#fff;background-color: #FA7846; border:1px solid #FA7846;border-radius: 8px;padding: 16px 50px;display: inline-block;">@lang('mail.i_want_the_same_one')</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
            ...
            <tr>
                <td align="center" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" valign="top" width="270" style="padding-left: 20px;">
                                <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 270px;display: inline-block;">
                                    <tr>
                                        <td align="left" valign="middle" width="35">
                                            <img src="https://viarcanvas.com/letters/new/email-icon.png" width="30" height="30" style="margin:0; padding:0; border:none; display:block;" border="0" alt="" />
                                        </td>
                                        <td align="left" valign="middle" width="30">
                                            <a style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 15px;
									line-height: 24px;color: #FA7846 !important;" href="mailto:orders@viarcanvas.com">orders@viarcanvas.com</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30" style="font-size:0; line-height:0;">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" width="35">
                                            <img src="https://viarcanvas.com/letters/new/location-icon.png" width="30" height="30" style="margin:0; padding:0; border:none; display:block;" border="0" alt="" />
                                        </td>
                                        <td align="left" valign="middle" width="194">
                                            <a href="https://www.google.com/maps/place/Viar+Art+Canvas/@55.8811515,26.5126457,17z/data=!3m1!4b1!4m5!3m4!1s0x46c295795530c25d:0x400f37c7743e684a!8m2!3d55.8811515!4d26.5148344"><span style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 15px;
									  line-height: 24px;color: #1E2533;">Rīga, Lubānas 65, LV-1073</span></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="10" style="font-size:0; line-height:0;">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="middle" width="194">
                                            <a href="https://www.google.com/maps/place/Viar+Art+Canvas/@55.8811515,26.5126457,17z/data=!3m1!4b1!4m5!3m4!1s0x46c295795530c25d:0x400f37c7743e684a!8m2!3d55.8811515!4d26.5148344">
                                                <span style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 15px;
									  line-height: 24px;color: #1E2533;">Daugavpils, Stacijas 129R, 
										LV5401</span>
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 270px;display: inline-block;">
                                    <tr>
                                        <td align="left" valign="top" width="120">
                                            <span style="font-family: Arial;font-style: normal;font-weight: bold;font-size: 15px;
										line-height: 22px;color: #1E2533;">@lang('mail.social_networks')</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" width="40">
                                            <a href="https://www.facebook.com/viarcanvas">
                                                <img src="https://viarcanvas.com/letters/new/facebook-icon.png" width="40" height="40" style="margin:0; padding:0; border:none; display:inline-block;" border="0" alt="facebook-icon" />
                                            </a>
                                            <a href="https://www.instagram.com/viarcanvas/">
                                                <img src="https://viarcanvas.com/letters/new/instagram-icon.png" width="40" height="40" style="margin:0; padding:0; border:none; display:inline-block;" border="0" alt="instagram-icon" />
                                            </a>
                                        </td>
                                    </tr>
                                </table>
            ...
            <tr>
                <td align="center" valign="top" style="padding-left: 10px;">
                    <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 575px;">
                        <tr>
                            <td align="left" valign="top">
                                <span style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;line-height: 135%;
							color: #808080;">@lang('mail.unsubscribe_1')</span>
                                <a style="font-family: Arial;font-style: normal;font-weight: normal;font-size: 15px;line-height: 135%;
							color: #fb7d4c;" href="https://google.com">
								 @lang('mail.unsubscribe_2')
							</a>
                            </td>
                        </tr>
                    </table>
