        ...
        <div class="popup-cart--wrapper">
            ...
            <div class="popup-cart--inner">
                ...
                <div class="portraits-btn">
                    ...
                    <a href="{{ route('cart.index') }}" rel="nofollow" class="go_to_cart @if (!Auth::check() && !request()->session()->get('email')) js-popup-repair-basket @endif" tabindex="0">{{ trans('canvas.modal_btn2') }}</a>
                </div>
            </div>
        </div>
    </div>
