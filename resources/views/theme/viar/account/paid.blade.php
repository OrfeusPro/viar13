		...
		<div class="main-cabinet__inner">
			<div class="cabinet-top__block">
				<div class="page-title cabinet-title">
					<span>@lang('account_new.paid.title')</span>
				...
				<div class="cabinet-grid">
					...
					<div class="cabinet-content">
						<div class="cabinet-payState">
							<div class="cabinet-payState__top">
								<p class="text-base">Оплата за: <b class="activeB">15 дней</b></p>
								<p class="text-base">Дата оплаты: <b class="activeB">14.05.2023</b></p>
								<p class="text-base">Сумма оплаты: <b class="activeB">250$</b> <a href="#">Скачать счёт</a></p>
							</div>
						...
						<div class="cabinet-content__icon">
							<img src="{{ asset(config('theme.current') . '/images')}}/cabinet/credit-card.svg" width="82" height="82"  @frontendAlt('theme/viar/account/paid.blade.php', (asset(config('theme.current') . '/images')) . '/cabinet/credit-card.svg', 'Viar Cabinet Peding Orders', '')>
						</div>
					</div>
				</div>
			</div>
