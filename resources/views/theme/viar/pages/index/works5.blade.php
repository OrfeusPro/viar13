    ...
    <div class="section-frame">
        ...
        <div class="work-list">
            <div class="work-item">
                <img data-src="{{ asset('images/work/work-1.svg') }}" class="work-photo lozad"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                     loading="lazy" @frontendAlt('theme/viar/pages/index/works5.blade.php', (asset('images/work/work-1.svg')), 'img', '')>
            ...
            <div class="work-item">
                <img data-src="{{ asset('images/work/work-2.svg') }}" class="work-photo lozad"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                     loading="lazy" @frontendAlt('theme/viar/pages/index/works5.blade.php', (asset('images/work/work-2.svg')), 'img', '')>
            ...
            <div class="work-item">
                <img data-src="{{ asset('images/work/work-3.svg') }}" class="work-photo lozad"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                     loading="lazy" @frontendAlt('theme/viar/pages/index/works5.blade.php', (asset('images/work/work-3.svg')), 'img', '')>
        ...
        <div class="work-time">
            <div class="work-time__item">
                <img src="{{ asset('images/work/work-4.svg') }}"  loading="lazy" @frontendAlt('theme/viar/pages/index/works5.blade.php', (asset('images/work/work-4.svg')), 'img', '')>
                <p>{!! trans('homepage_new.how_we_work_express') !!}</p>
            </div>
            <div class="work-time__item">
                <img src="{{ asset('images/work/work-5.svg') }}"  loading="lazy" @frontendAlt('theme/viar/pages/index/works5.blade.php', (asset('images/work/work-5.svg')), 'img', '')>
