    ...
    <div class="vz-art section-frame">
        <div class="vz-art header-bar">
            <a href="{{ route('home') }}" class="vz-art logo">
                <img loading="lazy" src="{{ asset('img/icons/logo.svg') }}" width="170" height="68"  class="img-svg" @frontendAlt('theme/viar/pages/index/header1.blade.php', (asset('img/icons/logo.svg')), __('settings.site_name'), '')>
            </a>
            ...
            <nav class="vz-art header-menu header-item_pc">
                <ul>
                    <li>
                        <a href="#" class="vz-art js-drop-menu" data-menu="1">
                            <span>{{ trans('header_footer_new.header_col1_name') }}</span>
                            <i class="fa-arrow-down"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="vz-art js-drop-menu" data-menu="2">
                            <span>{{ trans('header_footer_new.header_col2_name') }}</span>
                            <i class="fa-arrow-down"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="vz-art js-drop-menu" data-menu="3">
            ...
            <div class="vz-art header-button">
                <a href="{{ route('new_account.index') }}" class="acc__link vz-art header-user @if (!Auth::check()) js-popup-login @endif" aria-label="user link">
                    <i class="fa-user"></i>
                </a>
            ...
            <div class="vz-art language header-item_pc _spollers _one _esc">
                <p class="_spoller "><img class="lozad" loading="lazy" src="{{ asset('images/flag/' . app()->getLocale() . '.svg') }}" @frontendAlt('theme/viar/pages/index/header1.blade.php', (asset('images/flag/' . app()->getLocale() . '.svg')), '', '')> {{ ucfirst(app()->getLocale()) }} <i class="fa-arrow-down"></i>
                </p>
                ...
                <ul class="ver1_langs">
                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        ...
                        <li>
                            <a href="{{ $cur_url_mod }}">
                                <img class="lozad" loading="lazy" src="{{ asset('images/flag/' . $localeCode . '.svg') }}" @frontendAlt('theme/viar/pages/index/header1.blade.php', (asset('images/flag/' . $localeCode . '.svg')), '', '')> {{ $localeCode }}
                            </a>
                        </li>
                    @endforeach
                </ul>
