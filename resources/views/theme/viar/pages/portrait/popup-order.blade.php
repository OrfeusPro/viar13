                    ...
                    <div class="formalization__block--top-inner">
                        <h2 class="block-title">
                            @switch(Route::currentRouteName())
                                @case('graphic_portrait.new_page--royal')
                                    {{-- Если это новая королевская страница --}}
                                    @if ($h2_titles->fourth_block_h2 !== '')
                                        {!! $h2_titles->fourth_block_h2 !!}
                                    @else
                                        @lang('portrait_royal.popup_title')
                                    @endif
                                    @break

                                @case('graphic_portrait.oil')
                                    {{-- Если это масляный портрет --}}
                                    @if ($h2_titles->fourth_block_h2 !== '')
                                        {!! $h2_titles->fourth_block_h2 !!}
                                    @else
                                        @lang('pages.portrait_oil.oil-popup.title')
                                    @endif
                                    @break
                            ...
                            <div class="formalization-items">
                                                    ...
                                                    <div class="kviz-group__item kviz-grid">
                                                        <div class="kviz-radio js-checkbox kviz-radio_active">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    <source
                                                                        srcset="{{ ver_asset('images/sharj/holstPhoto.webp') }}"
                                                                        type="image/webp">
                                                        ...
                                                        <div class="kviz-radio js-checkbox">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    <source
                                                                        srcset="{{ ver_asset('images/sharj/paperPhoto.webp') }}"
                                                                        type="image/webp">
                                                                    <img width="112" height="119"
                                ...
                                <div class="formalization-item">
                                    <div class="formalization-box">
                                        ...
                                        <div class="formalization-content" style="">
                                            <div class="formalization-content--inner">
                                                <p class="underline-text check-js">{{ trans('portrait_royal.form_group_size_preview') }}</p>
                                                    ...
                                                    @foreach ( collect($list)->chunk(5) as $_chunk)
                                                        ...
                                                        <div class="kviz-group__item">
                                                            @foreach($_chunk as $_item)
                                                                <div class="kviz-radio js-checkbox @if($is_first_inner && $loop->index ==0) kviz-radio_active @endif " data-stock="1" data-price="{{$_item->price}}">
                                                                    <em class="check"></em>
                                                                    <label>
                                                                        {{-- <span>{{$_item->size[0]}}x{{$_item->size[1]}} {{ trans('gl.cm') }} - {{$_item->price_old>0?$_item->price_old:$_item->price}}€ @if($_item->price_old>0)
                                                                                <b>{{$_item->price}}€</b>@endif</span> --}}

                                                                        <span>
                                                                            {{$_item->size[0]}}x{{$_item->size[1]}} {{ trans('gl.cm') }} - 
                                                                            
                                                                            @if($_item->price_old != null) <span class="dec_lt"> @endif
                                                                            {{$_item->price_old>0?$_item->price_old:$_item->price}}€ 
                                                                            @if($_item->price_old != null) </span>@endif

                                                                            @if($_item->price_old>0)
                                                                                <b>{{$_item->price}}€</b>
                                                                            @endif
                                                                        </span>
                                                                        ...
                                                                        <input type="radio" name="size"
                                                                               ...
                                                                               value="{{$_item->size[0]}}x{{$_item->size[1]}}">
                                                                    </label>
                                                            ...
                                                            <div class="kviz-radio js__personal_checker js-checkbox kviz-types"
                                                                ...
                                                                <label>
                                                                    ...
                                                                    <input type="radio" name="users"
                                                                           value="{{$_item->count}}" data-count="{{$_item->count}}" data-price="{{$_item->price}}" disabled="">
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                    </div>
                ...
                <div class="formalization__block--bottom">
                    ...
                    <span>{{ $set->getTranslatedAttribute('name', app()->getLocale()) }}
                        <img src="{{ asset('images/icon/info.svg') }}" alt=""/></span>
                                                ...
                                                <div class="pic-pop">
                                                    @php
                                                        $popupSetImageSources = image_picture_sources($set->image, true);
                                                    @endphp
                                                    <picture>
                                                        @if(!empty($popupSetImageSources['src_webp']))
                                                            <source srcset="{{ $popupSetImageSources['src_webp'] }}" type="image/webp">
                                                        @endif
                                                        @if(!empty($popupSetImageSources['src']) && !empty($popupSetImageSources['type']))
                                                            <source srcset="{{ $popupSetImageSources['src'] }}"
                                                                    type="{{ $popupSetImageSources['type'] }}">
                                                        @endif
                                                        <img loading="lazy" src="{{ $popupSetImageSources['src'] }}"
                                ...
                                <div class="kviz-c-row kviz-c-group">
                                    ...
                                    <div class="kviz-radio js_terms js-checkbox" data-stock="2">
                                        ...
                                        <label>
                                            ...
                                            <input class="js_time" type="radio" name="equipment"
