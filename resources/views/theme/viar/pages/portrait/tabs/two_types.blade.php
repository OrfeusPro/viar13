    ...
    <div class="about__block-types">
        ...
        <div class="about__block-types-row">
            <div class="img imgCenter">
                <div class="flex">
                    <img width="40" height="40" src="{{ ver_asset('images/sharj/i1.svg') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/i1.svg')), '', '')>
            ...
            <ul>
                <li>
                    <img width="65" height="65" src="{{ ver_asset('images/sharj/ai1.webp') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/ai1.webp')), '', '')>
                    <p>{!! trans('portrait_royal.tab_two_types_body_list_1') !!}</p>
                </li>
                <li>
                    <img width="65" height="65" src="{{ ver_asset('images/sharj/ai2.webp') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/ai2.webp')), '', '')>
                    <p>{!! trans('portrait_royal.tab_two_types_body_list_2') !!}</p>
                </li>
                <li>
                    <img width="65" height="65" src="{{ ver_asset('images/sharj/ai3.webp') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/ai3.webp')), '', '')>
                    <p>{!! trans('portrait_royal.tab_two_types_body_list_3') !!}</b></p>
                </li>
            </ul>
            <div class="img imgCenter">
                <div class="flex">
                    <img width="40" height="40" src="{{ ver_asset('images/sharj/i2.svg') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/i2.svg')), '', '')>
        ...
        <div class="about__block-types-row">
            <div class="img">
                <div class="flex mb-2">
                    <img width="40" height="40" src="{{ ver_asset('images/sharj/i3.svg') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/i3.svg')), '', '')>
            ...
            <ul>
                <li>
                    <img width="65" height="65" src="{{ ver_asset('images/sharj/ai4.webp') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/ai4.webp')), '', '')>
                    <p>{!! trans('portrait_royal.tab_two_types_body_list_4') !!}</p>
                </li>
                <li>
                    <img width="65" height="65" src="{{ ver_asset('images/sharj/ai5.webp') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/ai5.webp')), '', '')>
                    <p>{!! trans('portrait_royal.tab_two_types_body_list_5') !!}</p>
                </li>
            </ul>
            <div class="img imgCenter">
                <div class="flex">
                    <img width="40" height="40" src="{{ ver_asset('images/sharj/i4.svg') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/two_types.blade.php', (ver_asset('images/sharj/i4.svg')), '', '')>
