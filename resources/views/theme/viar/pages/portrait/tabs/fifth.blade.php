...
$dl = [];
for ($i=1; $i<=9; $i++){
    $key = 'portrait_about_tab_about_deadline_'.$i;
    $dl[$i] = site_image($key, $map[$i], ['collection' => $siteImages]);
}
@endphp

<div class="about__block about__fifth brief-v @if($is_hidden ?? true) hidden-block @endif">
    <div class="about-deadline">
        <div class="deadline-block">
            <div class="deadline-title">
                <img src="{{ ver_asset('images/clock.png') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/fifth.blade.php', (ver_asset('images/clock.png')), '', '')/>
        ...
        <div class="deadline-block">
            <div class="deadline-title">
                <img src="{{ ver_asset('images/delivery.png') }}"  @frontendAlt('theme/viar/pages/portrait/tabs/fifth.blade.php', (ver_asset('images/delivery.png')), '', '')/>
