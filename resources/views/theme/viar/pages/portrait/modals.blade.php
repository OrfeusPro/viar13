...
<form data-portrait-by-photo-header="1" action="{{ route('send_photo_portrait_form') }}" method="POST" enctype="multipart/form-data"
        ...
        <picture>
            ...
            <img src="{{ asset('images/portrait-form.png') }}" class="vz-art photo-mokap"  loading="lazy"  @frontendAlt('theme/viar/pages/portrait/modals.blade.php', (asset('images/portrait-form.png')), 'img', '')/>
        </picture>
    </form>
@endif
