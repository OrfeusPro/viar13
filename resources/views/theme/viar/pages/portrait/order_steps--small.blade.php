        ...
        <div class="section-inner">
            <div class="title-row">
                ...
                <div class="section-badge">
                    <div class="pmo-block pmo-block1">
                        ...
                        <img width="52" height="80" src="{{ver_asset('images/sharj/pngwing.webp')}}"  @frontendAlt('theme/viar/pages/portrait/order_steps--small.blade.php', (ver_asset('images/sharj/pngwing.webp')), '', '')>
            ...
            <div class="steps-order__top">
                <div class="steps-order__top-item">
                    <img width="100" height="100" src="{{ asset('images/sharj/express.svg') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps--small.blade.php', (asset('images/sharj/express.svg')), '', '')>
                    <p>{!! trans('homepage_new.how_we_work_express') !!}</p>
                </div>
                <div class="steps-order__top-item">
                    <img width="100" height="100" src="{{ asset('images/sharj/standart.svg') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps--small.blade.php', (asset('images/sharj/standart.svg')), '', '')>
