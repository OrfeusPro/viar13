<div class="br-object">
    <div class="section-frame">
        <div class="breadcrumbs breadcrumbs__block">
            ...
            @if(isset($main_item) && $main_item->id !== $item->id)
                <div>
                    <a href="{{ route('caricature') }}" class="breadcrumbs__link breadcrumbs__link_main">
                        <span>{!! $main_item->getTranslatedAttribute('name') !!}</span>
                    </a>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="11" viewBox="0 0 6 11" fill="none"
                     class="img-svg breadcrumbs__arrow replaced-svg">
