                    ...
                    <div class="formalization__screen--inner">
                        ...
                        <div class="stages__wrapper">
                            <div class="stages-row">
                                <div class="stage-item">
                                    <div class="stage-img">
                                        <img src="{{ asset('images/photo.png') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/photo.png')), '', '')/>
                                ...
                                <div class="stage-item">
                                    <div class="stage-img">
                                        <img src="{{ asset('images/conversation.png') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/conversation.png')), '', '')/>
                                ...
                                <div class="stage-item">
                                    <div class="stage-img">
                                        <img src="{{ asset('images/portrait.png') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/portrait.png')), '', '')/>
                                ...
                                <div class="stage-item">
                                    <div class="stage-img">
                                        <img src="{{ asset('images/canvas.png') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/canvas.png')), '', '')/>
                                ...
                                <div class="stage-item">
                                    <div class="stage-img">
                                        <img src="{{ asset('images/delivery1.png') }}"  @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/delivery1.png')), '', '')/>
                        ...
                        <div class="work-time">
                            <div class="work-time__item">
                                <img src="{{ asset('images/work/work-4.svg') }}"  loading="lazy" @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/work/work-4.svg')), '', '')/>
                                <p>{!! trans('homepage_new.how_we_work_express') !!}</p>
                            </div>
                            <div class="work-time__item">
                                <img src="{{ asset('images/work/work-5.svg') }}"  loading="lazy" @frontendAlt('theme/viar/pages/portrait/order_steps.blade.php', (asset('images/work/work-5.svg')), '', '')/>
