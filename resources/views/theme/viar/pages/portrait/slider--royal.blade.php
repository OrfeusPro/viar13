<div class="portraits portrait__screen new-screen new-hero hb_slider_royal">
							...
							<div class="pmain__screen">
								...
								<div class="pm-object">
									...
									@if (isset($slide['fotopng']) && $slide['fotopng'])
										<div class="pms-block">
											@php
												$royalSliderPhotoSources = image_picture_sources(data_get($slide, 'fotopng'), true);
											@endphp
											<picture>
												@if(!empty($royalSliderPhotoSources['src_webp']))
													<source srcset="{{ $royalSliderPhotoSources['src_webp'] }}" type="image/webp">
												@endif
								...
								<div class="mp-m-bg">
									@if (isset($slide['fotopng']) && $slide['fotopng'])
										<div class="pms-block pms-block1">
											@php
												$royalSliderMobilePhotoSources = image_picture_sources(data_get($slide, 'fotopng'), true);
											@endphp
											<picture>
												@if(!empty($royalSliderMobilePhotoSources['src_webp']))
													<source srcset="{{ $royalSliderMobilePhotoSources['src_webp'] }}" type="image/webp">
												@endif
									...
									<div class="mobile-img">
										@php
											$royalSliderMobileImageSources = image_picture_sources(data_get($slide, 'image_mob'), true);
										@endphp
										<picture>
											@if(!empty($royalSliderMobileImageSources['src_webp']))
												<source media="(max-width: 520px)" srcset="{{ $royalSliderMobileImageSources['src_webp'] }}" type="image/webp">
											@endif
											@if(!empty($royalSliderMobileImageSources['src']) && !empty($royalSliderMobileImageSources['type']))
												<source media="(max-width: 520px)" srcset="{{ $royalSliderMobileImageSources['src'] }}" type="{{ $royalSliderMobileImageSources['type'] }}">
											@endif
											<img width="520" height="400" src="{{ $royalSliderMobileImageSources['src'] }}" @altAttrs(['type' => \App\Models\PortraitSlider::class, 'id' => $slide['id'] ?? null], 'image_mob', data_get($slide, 'image_mob'), null, 'Viar Image')>
										</picture>
									</div>
								...
								<div class="mp__inner">
									{{-- <div class="custom-shape-divider-top-1685701246">
                                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
									...
									<div class="section-frame">
										...
										<div class="portraits-btn mp-btn">
											<a href="#" class="js-image-calc" onclick="$('.formalization__subrow').hide()"
												tabindex="-1">{{ $slide['btn'] }}</a>
										</div>
