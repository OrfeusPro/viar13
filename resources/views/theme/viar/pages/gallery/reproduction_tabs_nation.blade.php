<div class="rp-block rp-nation hidden-block">
	<div class="rp-p-row">
		<div class="rp-search">
			<form class="mc-search" action="{{ route("hb.gallery.list_nationality") }}">
				<div class="mc-input">
	...
	<div class="rp-nations">
		<div class="p-text">
			@lang("gallery.select_nationality"):
		</div>
		<div class="rp-results">
			<ul>
				@foreach ($gallery_nationality as $nationality)
					<li><a href="{{ route('hb.gallery.nationality', ["alias"=> $nationality->alias]) }}">{{ translated_value($nationality, 'name', $nationality->name) }}</a></li>
				@endforeach
			</ul>
		</div>
	</div>
