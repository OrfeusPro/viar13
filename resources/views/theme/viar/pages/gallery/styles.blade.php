		...
		<div class="section-frame">
			<div class="reproduction-inner">
				...
				<picture>
					...
					<img width="1350" height="381" src="{{ asset(env('THEME') . 'images') }}/reproduction/1.jpg"  @frontendAlt('theme/viar/pages/gallery/styles.blade.php', (asset(env('THEME') . 'images')) . '/reproduction/1.jpg', '', '')>
				</picture>
				<div></div>
			</div>
		</div>
                                    ...
                                    <picture>
                                        ...
                                        @else
                                            ...
                                            <img width="433" height="583" src="{{ asset(env('THEME') . 'images') }}/gallery/7.jpg"
                                                  loading="lazy" @frontendAlt('theme/viar/pages/gallery/styles.blade.php', (asset(env('THEME') . 'images')) . '/gallery/7.jpg', ($item->name), ($item->name))>
                                        @endif
                                    </picture>
                                </div>
                                <p>{{ $item->name }}</p>
