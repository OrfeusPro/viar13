<div class="mobile-ell">
    <img src="{{ asset('images/sizes/union.png') }}"  @frontendAlt('theme/viar/pages/canvas/sizes.blade.php', (asset('images/sizes/union.png')), '', '')/>
...
<div class="sizes__screen section-p">
    <div class="sizes__screen--inner">
        <picture>
            ...
            <img src="{{ asset('images/sizes/size-bg.jpg') }}"  @frontendAlt('theme/viar/pages/canvas/sizes.blade.php', (asset('images/sizes/size-bg.jpg')), 'img', '')/>
        </picture>
        <picture>
            ...
            <img class="boy" src="{{ asset('images/sizes/10.webp') }}"  @frontendAlt('theme/viar/pages/canvas/sizes.blade.php', (asset('images/sizes/10.webp')), '', '')/>
        </picture>
        <picture>
            <source srcset="{{ asset('images/sizes/9.webp') }}" type="image/webp"/>
            <source srcset="{{ asset('images/sizes/9.png') }}" type="image/png"/>
            <img class="girl" src="{{ asset('images/sizes/9.webp') }}"  @frontendAlt('theme/viar/pages/canvas/sizes.blade.php', (asset('images/sizes/9.webp')), '', '')/>
        </picture>
...
<div class="ellipse ellipse_top">
    ...
    <img  src="{{ asset('images/icon/ellipse-whete.svg') }}" decoding="async" height="99" width="1374" @frontendAlt('theme/viar/pages/canvas/sizes.blade.php', (asset('images/icon/ellipse-whete.svg')), 'img', '')>
</div>
