                                ...
                                <label>
                                    ...
                                    @if($improve->image)
                                        <div class="pic-pop">
                                            <picture>
                                                @php
                                                    $improveImageSources = image_picture_sources(data_get($improve, 'image'), true);
                                                @endphp
                                                @if(!empty($improveImageSources['src_webp']))
                                                    <source srcset="{{ $improveImageSources['src_webp'] }}" type="image/webp">
                                                @endif
                                                @if(!empty($improveImageSources['src']) && !empty($improveImageSources['type']))
                                                    <source srcset="{{ $improveImageSources['src'] }}" type="{{ $improveImageSources['type'] }}">
                                                @endif
                                                <img loading="lazy" src="{{ $improveImageSources['src'] }}" @altAttrs($improve, 'image', data_get($improve, 'image'))>
                                            </picture>
                                            @if($improveHint)
