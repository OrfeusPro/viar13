...
<div class="accordion-content canvas-x-scroll-inline-flex">
    ...
    <script>
        (function() {
            ...
            const slider = document.querySelector('.canvas-x-scroll-inline-flex');
            let isDown = false;
            let startX;
            let scrollLeft;

            // Обработчик для начала перетаскивания (мышь)
            slider.addEventListener('mousedown', (e) => {
                isDown = true;
                slider.classList.add('active'); // Добавить класс для изменения курсора (опционально)
                startX = e.pageX - slider.offsetLeft;
                scrollLeft = slider.scrollLeft;
            });

            // Обработчик для окончания перетаскивания (мышь)
            ...
            slider.addEventListener('mousemove', (e) => {
                ...
                const walk = (x - startX) * 1; // Регулируйте скорость прокрутки
