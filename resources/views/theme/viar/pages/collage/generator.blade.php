                                                    ...
                                                    <div class="collage-settings">
                                                        <div class="filter-picture tabs-item tabs-item1 active">
                                                            ...
                                                            <div class="cs-controls cs-ds-controls">
                                                                <div class="csc-item" id="delete_background"
                                                            ...
                                                            <div class="cs-wrapper">
                                                                <div class="cs-wrapper--inner">
                                                                    <div class="cs-s-item cs-s-sizes">
                                                                    ...
                                                                    <div
                                                                        class="cs-s-item cs-wrapper--form hidden-block">
                                                                    ...
                                                                    <div class="cs-s-item hidden-block">
                                                                        ...
                                                                        <div class="cs-ph-container">
                                                                            <div class="product-download pd-family"
                                                                                id="imgs2">
                                                                                ...
                                                                                <div class="cs-btn-scroll heartbeat">
                                                                                    <svg width="11" height="7"
                                                                                        ...
                                                                                        <path
                                                                                            d="M0.676759 0.142211C0.75 0.0689688 0.834228 0.0323475 0.929443 0.0323475C1.02466 0.0323475 1.10889 0.0689688 1.18213 0.142211L5.49976 4.45984L9.81738 0.142211C9.89063 0.0689688 9.97485 0.0323475 10.0701 0.0323475C10.1653 0.0323475 10.2495 0.0689688 10.3228 0.142211L10.8721 0.691528C10.9453 0.76477 10.9819 0.848998 10.9819 0.944213C10.9819 1.03943 10.9453 1.12366 10.8721 1.1969L5.75244 6.31653C5.6792 6.38977 5.59497 6.42639 5.49976 6.42639C5.40454 6.42639 5.32031 6.38977 5.24707 6.31653L0.127441 1.1969C0.0541989 1.12366 0.0175781 1.03943 0.0175781 0.944213C0.0175781 0.848998 0.0541989 0.76477 0.127441 0.691528L0.676759 0.142211Z"
                                                                                            fill="white" />
                                                                                    </svg>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="js_zone">
                                                                                        <div class="img img__place">
                                                                                            <div
                                                                                                ...
                                                                                                <svg>
                                                                                                    <use
                                                                                                        xlink:href="{{ asset(env('THEME') . 'sprite.svg#save') }}">
                                                                                                    </use>
                                                                                                </svg>
                                                                                                <div
                                                                                                    class="file-save__title">
                                                                                                    <p>{!! trans('collage_new.z7_generator_foto_text3') !!}
                                                                                                    </p>
                                                                        ...
                                                                        <div class="additional-image">
                                                                            <div class="additional-row">
                                                                                <div class="additional-img">
                                                                                    <img loading="lazy"
                                                                                        src="{{ asset('images/canvas/additional.svg') }}"
                                                                                        alt="">
                                                                                </div>
                                                                                <div class="additional-input">
                                                                                    <div
                                                                                        class="vz-art popup-log-check js-checkbox">
                                                                                        <span class="vz-art log-check">
                                                                                            <svg
                                                                                                class="vz-art kviz-input__icon">
                                                                                                <use
                                                                                                    xlink:href="{{ asset(env('THEME') . 'sprite.svg#log') }}">
                                                                                                </use>
                                                                                            </svg>
                                                                                        </span>
                                                                            ...
                                                                            <div class="additional-hidden">
                                                                                <div class="kviz-wrap">
                                                                                    ...
                                                                                    <div
                                                                                        class="kviz-c-row kviz-c-group">
                                                                                        <div class="kviz-radio js-checkbox kviz-radio_active"
                                                                                            data-stock="1">
                                                                                            <div
                                                                                                class="check check-border">
                                                                                            </div>
                                                                                            <label>
                                                                                                ...
                                                                                                <input name="boxes2[]"
                                                                                                    ...
                                                                                                    data-id="2"
                                                                                                    checked
                                                                                                    data-name="{!! trans('collage_new.z7_generator_foto_text8') !!}"
                                                                                                    value="0">
                                                                                                <div
                                                                                                    class="window-prompt">
                                                                                        ...
                                                                                        <div class="kviz-radio js-checkbox"
                                                                                            ...
                                                                                            <label>
                                                                                                <span>{!! trans('collage_new.z7_generator_foto_text9') !!}<img
                                                                                                        loading="lazy"
                                                                                                        src="{{ asset('images/icon/info.svg') }}"
                                                                                                        alt="">
                                                                                                </span>
                                                                                                <input name="boxes2[]"
                                                                                                    type="radio"
                                                                                                    data-id="1"
                                                                                                    data-name="{!! trans('collage_new.z7_generator_foto_text9') !!}"
                                                                                                    value="3">
                                                                                                <div
                                                                                                    class="window-prompt">
                                                                                        ...
                                                                                        <div class="kviz-radio js-checkbox"
                                                                                            ...
                                                                                            <label
                                                                                                class="jcf-label-active">
                                                                                                <span>{!! trans('collage_new.z7_generator_foto_text10') !!}<img
                                                                                                        loading="lazy"
                                                                                                        src="{{ asset('images/icon/info.svg') }}"
                                                                                                        alt=""></span>
                                                                                                <input name="boxes2[]"
                                                                                                    type="radio"
                                                                                                    data-id="3"
                                                                                                    data-name="{!! trans('collage_new.z7_generator_foto_text10') !!}"
                                                                                                    value="4">
                                                                                                <div
                                                                                                    class="window-prompt">
                                                                    ...
                                                                    <div class="cs-s-item hidden-block">
                                                                        ...
                                                                        <button type="button" class="user-txt-btn"
                                                                            id="add_text">{!! trans('collage_new.z7_generator_foto_block_add') !!}</button>
                                                                    ...
                                                                    <div class="cs-s-item hidden-block">
                                                                        ...
                                                                        <div class="cs-smiles_inner">
                                                                            <div class="cs-smiles_tabs">
                                                                                @if ($ACollageStickerGroup)
                                                                                    @foreach ($ACollageStickerGroup as $sticker_group)
                                                                                        <div
                                                                                            class="cs-smiles_tab @if ($loop->iteration === 1) active @endif">
                                                                                            {{ $sticker_group->title }}
                                                                                        </div>
                                                                                    @endforeach
                                                                                @endif
                                                                            ...
                                                                            <div class="cs-smiles_column"
                                                                                id="smiles">
                                                                                @if ($ACollageStickerGroup)
                                                                                    @foreach ($ACollageStickerGroup as $sticker_group)
                                                                                        <div
                                                                                            class="cs-smiles_block @if ($loop->iteration === 1) active @else hidden-block @endif">
                                                                                            @foreach ($ACollageStiker as $sticker)
                                                                                                @if ($sticker->stiker_group_id == $sticker_group->id)
                                                                                                    <div
                                                                                                        class="cs-smiles_item">
                                                                                                        <img loading="lazy"
                                                                                                            width="70"
                                                                                                            height="70"
                                                            ...
                                                            <div class="filter-accordion">
                                                                    ...
                                                                    <div class="interior-slider">
                                                                        <div>
                                                                            <div data-item="0"
                                                                                ...
                                                                                data-size="250,300"
                                                                                data-interior="{{ asset('images/canvas/interio1.jpg') }}">
                                                                                ...
                                                                                <div class="interio-img">
                                                                                    <picture>
                                                                                        <source
                                                                                            ...
                                                                                            srcset="{{ asset('images/canvas/interio1Min.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio1Min.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio1.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio1.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <img loading="lazy"
                                                                        ...
                                                                        <div>
                                                                            <div data-item="1" class="interior-item"
                                                                                data-size="300,400"
                                                                                data-interior="{{ asset('images/canvas/interio2.jpg') }}">
                                                                                ...
                                                                                <div class="interio-img">
                                                                                    <picture>
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio2Min.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio2Min.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio2.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio2.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <img loading="lazy"
                                                                        ...
                                                                        <div>
                                                                            <div data-item="2" class="interior-item"
                                                                                data-size="350,400"
                                                                                data-interior="{{ asset('images/canvas/interio3.jpg') }}">
                                                                                ...
                                                                                <div class="interio-img">
                                                                                    <picture>
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio3Min.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio3Min.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio3.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio3.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <img loading="lazy"
                                                                        ...
                                                                        <div>
                                                                            <div data-item="3" class="interior-item"
                                                                                data-size="250,300"
                                                                                data-interior="{{ asset('images/canvas/interio4.jpg') }}">
                                                                                ...
                                                                                <div class="interio-img">
                                                                                    <picture>
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio4Min.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio4Min.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio4.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio4.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <img loading="lazy"
                                                                        ...
                                                                        <div>
                                                                            <div data-item="4" class="interior-item"
                                                                                data-size="350,400"
                                                                                data-interior="{{ asset('images/canvas/interio5.jpg') }}">
                                                                                ...
                                                                                <div class="interio-img">
                                                                                    <picture>
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio5Min.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            media="(max-width: 550px)"
                                                                                            srcset="{{ asset('images/canvas/interio5Min.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio5.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/interio5.jpg') }}"
                                                                                            type="image/jpeg">
                                                                                        <img loading="lazy"
                                                                            ...
                                                                            <div class="range__box"
                                                                                ...
                                                                                <div class="range_box">
                                                                                    ...
                                                                                    <div class="changeSm">
                                                                                        <div>
                                                                                            <span
                                                                                                class="js_s1">250</span>
                                                                                            {!! trans('collage_new.sm') !!}
                                                                                        </div>
                                                                                        <div>
                                                                                            <span
                                                                                                class="js_s2">300</span>
                                                                                            {!! trans('collage_new.sm') !!}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="range__box">
                                                                                ...
                                                                                <div class="range_box">
                                                                                    ...
                                                                                    <div class="changeSm">
                                                                                        <div>
                                                                                            <span
                                                                                                class="js_s1">300</span>
                                                                                            {!! trans('collage_new.sm') !!}
                                                                                        </div>
                                                                                        <div>
                                                                                            <span
                                                                                                class="js_s2">400</span>
                                                                                            {!! trans('collage_new.sm') !!}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div class="accordion-content frames"
                                                                    ...
                                                                    <div class="ramu-slider js_rams"
                                                                        style="display: none;">
                                                                        <label>
                                                                            <div data-price="0" ramu_zero_item=""
                                                                                data-interior="empty"
                                                                                class="ramu-item active">
                                                                                <input
                                                                                    style="opacity: 0; position: absolute; pointer-events: none;"
                                                                                    type="radio" name="ram_id"
                                                                                    value="12" />
                                                                                <div class="selected-icon">
                                                                                    <svg width="12" height="9"
                                                                                        viewBox="0 0 12 9"
                                                                                ...
                                                                                <span
                                                                                    class="code">{!! trans('collage_new.z7_generator_ramma_text2') !!}</span>
                                                                                <span
                                                                                    class="price">{!! trans('collage_new.z7_generator_ramma_text3') !!}</span>
                                                                            </div>
                                                                        </label>
                                                                        <label>
                                                                            <div data-price="25" class="ramu-item"
                                                                                data-src="{{ asset('images/canvas/ram1.jpg') }}"
                                                                                data-width="10">
                                                                                <input
                                                                                    style="opacity: 0; position: absolute; pointer-events: none;"
                                                                                    type="radio" name="ram_id"
                                                                                ...
                                                                                <span
                                                                                    class="code">{!! trans('collage_new.z7_generator_ramma_text4') !!}</span>
                                                                                <div class="img">
                                                                                    <picture>
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/rama1.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                        ...
                                                                        <label>
                                                                            <div data-price="25" class="ramu-item"
                                                                                data-src="{{ asset('images/canvas/ram2.jpg') }}"
                                                                                data-width="10">
                                                                                <input
                                                                                    style="opacity: 0; position: absolute; pointer-events: none;"
                                                                                    type="radio" name="ram_id"
                                                                                ...
                                                                                <span
                                                                                    class="code">{!! trans('collage_new.z7_generator_ramma_text5') !!}</span>
                                                                                <div class="img">
                                                                                    <picture>
                                                                                        <source
                                                                                            srcset="{{ asset('images/canvas/rama2.webp') }}"
                                                                                            type="image/webp">
                                                                                        <source
                                                                ...
                                                                <div
                                                                    class="accordion-content accordion-content-sizes frames">
                                                            ...
                                                            <div class="PhotoEditor" id="PhotoEditor">
                                                                ...
                                                                <div class="wrapper">
                                                                    ...
                                                                    <div class="cs-canvs_settings settings">
                                                                        <div class="range">
                                                                            <div class="caption">
                                                                                {!! trans('collage_new.z7_generator_controls13') !!}
                                                                            </div>
                                                                            <input id="range_radius" class="slider"
                                                                                type="range" min="0"
                                                                                max="100" value="10">
                                                                        </div>
                                                                        <div class="range">
                                                                            <div class="caption">
                                                                                {!! trans('collage_new.z7_generator_controls14') !!}
                                                                            </div>
                                                                            <input id="range_between" class="slider"
                                                                                type="range" min="0"
                                                                                max="100" value="20">
                                                                        </div>
                                                                        <div class="fullscreen-change"
                                                                            id="fullscreen">
                                                            ...
                                                            <div id="interior_container" class="interior_container">
                                                                ...
                                                                <div class="tools">
                                                                    <div id="interior_fullscreen"
                                                                        class="tool icontool-fullscreen"> </div>
                    ...
                    <div class="formalization__block--bottom">
                        <div class="formalization__final">
                            <div class="formalizaton__submit">
                                ...
                                <div class="formalization-btn sbm__collage"
                                    data-route="{{ route('add_item_to_basket_construct') }}" data-pid="2"
                                    data-name="Collage" href="javascript:void(0)">{!! trans('collage_new.z7_generator_total_text2') !!}</div>
