 ...
 <div class="collage-advantage__screen">
     <div class="section-frame">
         <div class="collage-advantage--inner">
             <div class="page-title--row">
                 <div class="page-title page-collage-title">
                     {!! trans('collage_new.z0_advantage_screen_title') !!}
                 </div>
                 <div class="col-subtitle">
                     {!! trans('collage_new.z0_advantage_screen_subtitle') !!}
                 </div>
             </div>
             @if ($ACollageAdvantageScreen)
                 <div class="collage-advantage--slider">
                     <div class="collage-advantage--slider_inner">
                         @foreach ($ACollageAdvantageScreen as $advantage_screen)
                                 ...
                                 <div class="collage-slider--item__body">
                                     <div class="collage-advantage_s--img">
                                         <img loading="lazy" width="80" height="80"
                                             src="{{ asset($advantage_screen->image) }}"  @frontendAlt('theme/viar/pages/collage/advantage_screen.blade.php', (asset($advantage_screen->image)), 'Viar Image', '')>
                                     </div>
                                     <div class="collage-advantage_s--content">
                                         <div class="collage-advantage_s--title">
                                             {!! $advantage_screen->getTranslatedAttribute('title') !!}
                                         </div>
                                         <div class="collage-advantage_s--text">
                                             {!! $advantage_screen->getTranslatedAttribute('text') !!}
                                         </div>
                                     </div>
                                 </div>
                             </div>
                     ...
                     <div class="collage-advantage-nav examples-arrow">
                         <a href="#" class="collage-advantage-prev examples-prev">
                         ...
                         <a href="#" class="collage-advantage-next examples-next">
                             <svg width="48" height="51" viewBox="0 0 48 51" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path
             ...
             @endif
             {{-- <div class="collage-advantage__image">
              <img width="774" height="470" src="{{ asset(env('THEME').'images/collage/advantage.png') }}" alt="Viar Image" loading="lazy">
              <div class="advantage-gift">
                <img loading="lazy" width="305" height="200" src="{{ asset('images/collage/gift2.svg') }}" alt="Viar Image">
                <p>{!! trans('collage_new.z0_advantage_screen_advantage_gift') !!}</p>
              </div>
              <div class="advantage-price">
                <p>{!! trans('collage_new.z0_advantage_screen_advantage_price') !!}</p>
                <img loading="lazy" width="99" height="92" src="{{ asset('images/collage/percent.svg') }}" alt="Viar Image">
              </div>
            </div> --}}
         </div>
     </div>
