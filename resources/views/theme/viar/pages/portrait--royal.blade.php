<div>
    ...
    <div itemprop="offers" itemtype="https://schema.org/Offer" itemscope>
        ...
        @else
            ...
            <div class="ellipse">
                <img  src="{{ asset(env('THEME').'images/icon/ellipse-whete.svg') }}" decoding="async" height="99" width="1374"  @frontendAlt('theme/viar/pages/portrait--royal.blade.php', (asset(env('THEME').'images/icon/ellipse-whete.svg')), 'img', '')/>
            </div>
        @endif
