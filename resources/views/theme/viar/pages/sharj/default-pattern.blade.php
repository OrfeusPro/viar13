...
<div class="portraitNew-slider-wrapper">
    ...
    <div class="portraitNew-slider">
        <?php $appUrl = config('app.url');  $i=100; ?>
        <?php foreach ($ba_items2 as $ba_item){
              $i++;
//            $absoluteImagePath= public_path($ba_item->getUrl());
             $absoluteImagePath= public_path($ba_item->getUrl());
//            $absoluteImagePath=  str_replace("https://", "http://", $ba_item->getUrl());
            ...
            if (file_exists($absoluteImagePath)) {
                ...
                if ($imageDimensions !== false) {
                    ...
                    if ($width>$height) { $class='h-auto';} else { $class='';}
                }
            }
            ?>
        ...
        <div class="portrait-list__item">
            ...
            <div class="portrait-list__img">
                @php
                    $sharjDefaultPatternImageSources = image_picture_sources($ba_item->getUrl(), true);
                @endphp
                <picture>
                    @if(!empty($sharjDefaultPatternImageSources['src_webp']))
                        <source srcset="{{ $sharjDefaultPatternImageSources['src_webp'] }}" type="image/webp">
                    @endif
