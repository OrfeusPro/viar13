...
<div class="section aboutInfo">
    <div class="pmo-block pmo-block1">
        ...
        <img width="52" height="80" src="{{ asset(env('THEME') . 'images') }}/sharj/new/pngwing.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/pngwing.webp', '', '')>
        ...
        <div class="section-inner">
            <div class="about__block-types">
                ...
                <div class="about__block-types-row">
                    <div class="img">
                        <div class="flex">
                            <img width="40" height="40" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/i1.svg"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/i1.svg', '', '')>
                    ...
                    <ul>
                        <li>
                            <img width="65" height="65" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/ai1.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/ai1.webp', '', '')>
                            <p>@lang("sharj.translate8")</p>
                        </li>
                        <li>
                            <img width="65" height="65" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/ai2.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/ai2.webp', '', '')>
                            <p>@lang("sharj.translate9")</p>
                        </li>
                        <li>
                            <img width="65" height="65" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/ai3.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/ai3.webp', '', '')>
                            <p>@lang("sharj.translate10")</p>
                        </li>
                    </ul>
                    <div class="img">
                        <div class="flex">
                            <img width="40" height="40" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/i2.svg"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/i2.svg', '', '')>
                ...
                <div class="about__block-types-row">
                    <div class="img">
                        <div class="flex mb-2">
                            <img width="40" height="40" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/i3.svg"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/i3.svg', '', '')>
                    ...
                    <ul>
                        <li>
                            <img width="65" height="65" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/ai4.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/ai4.webp', '', '')>
                            <p>@lang("sharj.translate13")</p>
                        </li>
                        <li>
                            <img width="65" height="65" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/ai5.webp"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/ai5.webp', '', '')>
                            <p>@lang("sharj.translate14")</p>
                        </li>
                    </ul>
                    <div class="img">
                        <div class="flex">
                            <img width="40" height="40" src="{{ asset(env('THEME') . 'images') }}/sharj/new/page/i4.svg"  @frontendAlt('theme/viar/pages/sharj/decoration.blade.php', (asset(env('THEME') . 'images')) . '/sharj/new/page/i4.svg', '', '')>
