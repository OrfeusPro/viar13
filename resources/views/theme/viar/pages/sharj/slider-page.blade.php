<div class="portraits portrait__screen new-screen new-hero hb_slider_sharj-page">
					...
					<div class="portraits-slide sl-slider pp-screen">
						<div class="m-screen-slide">
							<div class="pmain__screen">
								@php
									$sharjPageSlideImageSources = image_picture_sources(data_get($slide, 'image'), true);
								@endphp
								<picture>
									@if(!empty($sharjPageSlideImageSources['src_webp']))
										<source srcset="{{ $sharjPageSlideImageSources['src_webp'] }}" type="image/webp">
									@endif
									@if(!empty($sharjPageSlideImageSources['src']) && !empty($sharjPageSlideImageSources['type']))
										<source srcset="{{ $sharjPageSlideImageSources['src'] }}" type="{{ $sharjPageSlideImageSources['type'] }}">
									@endif
									<img width="1920" height="900" src="{{ $sharjPageSlideImageSources['src'] }}" @altAttrs(['type' => \App\Models\PortraitSlider::class, 'id' => $slide['id'] ?? null], 'image', data_get($slide, 'image'), null, 'Viar Image')>
								</picture>
								<div class="pm-object sharj-pm-object">
									@php
										$sharjPageSlidePngSources = image_picture_sources(data_get($slide, 'png'), true);
									@endphp
									<picture>
										@if(!empty($sharjPageSlidePngSources['src_webp']))
											<source srcset="{{ $sharjPageSlidePngSources['src_webp'] }}" type="image/webp">
										@endif
								...
								<div class="mp-m-bg">
									...
									<div class="mobile-img sharj-mobile-img">
										@php
											$sharjPageSlideMobileSources = image_picture_sources(data_get($slide, 'image_mob'), true);
										@endphp
										<picture>
											@if(!empty($sharjPageSlideMobileSources['src_webp']))
												<source srcset="{{ $sharjPageSlideMobileSources['src_webp'] }}" type="image/webp">
											@endif
											@if(!empty($sharjPageSlideMobileSources['src']) && !empty($sharjPageSlideMobileSources['type']))
												<source srcset="{{ $sharjPageSlideMobileSources['src'] }}" type="{{ $sharjPageSlideMobileSources['type'] }}">
											@endif
											<img width="370" height="500" src="{{ $sharjPageSlideMobileSources['src'] }}" @altAttrs(['type' => \App\Models\PortraitSlider::class, 'id' => $slide['id'] ?? null], 'image_mob', data_get($slide, 'image_mob'), null, 'Viar Image')>
										</picture>
									</div>
									<div class="pmm-block">
                                ...
                                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
									...
									<div class="section-frame">
										...
										<div class="portraits-btn mp-btn js-simps-calc">
