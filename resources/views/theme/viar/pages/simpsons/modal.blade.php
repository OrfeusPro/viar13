                ...
                <div class="formalization__block--top">
                    <div class="formalization__block--top-inner">
                        <div class="simpson-titleBlock">
                            ...
                            <img width="148" height="179" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/formTitle1.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/formTitle1.webp')), '', '')>
                        </div>
                        ...
                        <div class="formalization__col">
                            ...
                            <div class="formalization-items">
                                ...
                                <div class="formalization-item">
                                    <div class="formalization-box">
                                        <div class="formalization-tab">
                                            <img width="25" height="25" src="{{ asset(config('theme.current') . '/images/sharj/new/format7.svg') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/format7.svg')), '', '')>
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p1.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p1.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p2.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p2.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p3.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p3.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p4.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p4.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p5.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p5.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p6.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p6.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p7.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p7.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                                        ...
                                                        <div class="portrait-list__item">
                                                            ...
                                                            <div class="portrait-list__img">
                                                                <picture>
                                                                    ...
                                                                    <img width="157" height="116" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/p8.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/p8.webp')), '', '')>
                                                                </picture>
                                                                <div class="zoom-in">
                                                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_1809_176)">
                                    ...
                                    <div class="formalization-prompt">
                                        <div class="formalization-prompt--wrapper">
                                            <div class="formalization-prompt--inner">
                                                <img width="56" height="58" src="{{ asset(config('theme.current') . '/images/sharj/new/ficon1.webp') }}"   @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/ficon1.webp')), '', '')/>
                                ...
                                <div class="formalization-item">
                                    <div class="formalization-box">
                                        <div class="formalization-tab">
                                            <img width="25" height="25" src="{{ asset(config('theme.current') . '/images/sharj/new/format1.svg') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/format1.svg')), '', '')>
                                                        ...
                                                        <div class="kviz-radio js-checkbox kviz-radio_active">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    ...
                                                                    <img width="112" height="119" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/simpsonHolst.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/simpsonHolst.webp')), '', '')>
                                                                </picture>
                                                        ...
                                                        <div class="kviz-radio js-checkbox">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    ...
                                                                    <img width="112" height="119" src="{{ asset(config('theme.current') . '/images/sharj/new/simpson/simpsonPaper.webp') }}"  @frontendAlt('theme/viar/pages/simpsons/modal.blade.php', (asset(config('theme.current') . '/images/sharj/new/simpson/simpsonPaper.webp')), '', '')>
                                                                </picture>
