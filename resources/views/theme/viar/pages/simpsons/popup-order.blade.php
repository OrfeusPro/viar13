...
<form class="formalization simpson-formalization" id="simpsons-calc">
                ...
                <div class="formalization__block--top">
                    <div class="formalization__block--top-inner">
                        <div class="simpson-titleBlock">
                            @if (isset($merchant))
                                <h2> @lang("simpson.simpson-formalization.simpson-titleBlock") </h2>
                              @else
                                                    ...
                                                    <div class="kviz-group__item kviz-grid">
                                                        <div class="kviz-radio js-checkbox kviz-radio_active">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    <source
                                                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/simpsonHolst.webp') }}"
                                                                        type="image/webp">
                                                        ...
                                                        <div class="kviz-radio js-checkbox">
                                                            ...
                                                            <label>
                                                                ...
                                                                <picture class="kviz-image">
                                                                    <source
                                                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/simpsonPaper.webp') }}"
                                                                        type="image/webp">
                                                                    <img width="112" height="119"
                                                                  ...
                                                                  <div itemprop="offers" itemtype="https://schema.org/Offer" itemscope>
                                                                        ...
                                                                        <meta itemprop="price" content="
                                                                          @if($_item->price_old>0)
                                                                                {{$_item->price}}
                                                                                @else  {{$_item->price_old>0?$_item->price_old:$_item->price}} @endif
                                                                              "/>

                                                                        <meta itemprop="description"  content="{{$cleanName}} on {{$name}} {{$_item->size[0]}}x{{$_item->size[1]}} {{ trans('gl.cm') }}" >
                                                                    </div>
                                                                    @endif
                                                                    ...
                                                                    <label>
                                                                        {{-- <span>
                                                                            {{$_item->size[0]}}x{{$_item->size[1]}} {{ trans('gl.cm') }} - {{$_item->price_old>0?$_item->price_old:$_item->price}}€ @if($_item->price_old>0)
                                                                                <b>{{$_item->price}}€</b>@endif
                                                                        </span> --}}
