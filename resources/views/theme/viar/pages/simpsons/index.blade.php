                ...
                <div class="section-inner">
                    <div class="simpson-screen">
                        <div class="content">
                            ...
                            <a href="#simpsons-calc" class="yellow-btn ">
...
<section class="about__screen about__screen-simpson" id="about">
    <div class="section-frame section-m-frame">
        <div class="about__screen--wrapper"><br>
            <h2 class="simpson-title">
                @lang('simpson.first_h2') </h2>
        ...
        <div class="about__screen--blocks">
            <div class="about__block">
                <div class="simpson-image">
                        ...
                        @if (!$backgrounds->isEmpty())
                            ...
                            @foreach ($backgrounds as $background)
                                ...
                                <div class="portrait-list__item {{ $class }}">
                                    <p> {!! $background->custom_properties[$locale] !!} </p>
                                    <?php $string = $background->getUrl(); ?>
                                    ...
                                    <div class="portrait-list__img">
                                        ...
                                        <a href="#simpsons-calc" attr_image="{{ $string }}" attr_type="fon"
                                            ...
                                            onclick="$('input[name=obraz_img]').val('{{ $string }}'); $('input[name=obraz_title]').val('{{ $background->id }}'); $('.popup-dyn-image').attr('src','{{ $background->src }}')" data-name="{{ $loop->iteration }}" obg="@lang("cart_new.obraz") #{{ $background->id }}"
                                            >
                    ...
                    @if ($j>$max)
                    <a href="#" class="top-all js_more_wks" data-more="{{ trans('homepage_new.simpsons_top_sales_more_btn_title') }}" data-less="@lang('homepage_new.hide')">
                        <picture>
            ...
            $base = asset(env('THEME').'images').'/sharj/new/simpson/';
            ...
            */
            $defs = [
                ...
                'simpsons_on_canvas_in_a_baguette_frame' => ['desk' => 'a1.webp', 'mob' => 'a1Min.webp', 'w'=>450, 'h'=>360],
                'simpsons_on_paper_in_a_simple_frame'  => ['desk' => 'a3.webp', 'mob' => 'a3Min.webp', 'w'=>450, 'h'=>360],
                ...
                <div class="about__block-types">
                    ...
                    <div class="about__block-types-row">
                        ...
                        <div class="img">
                            ...
                            @php
                                $k = 'simpsons_on_canvas_in_a_baguette_frame';
                            @endphp
                            <picture>
                            @if(!empty($car[$k]['mob']['src_webp']))
                                <source media="(max-width: 576px)" srcset="{{ $car[$k]['mob']['src_webp'] }}" type="image/webp">
                    ...
                    <div class="about__block-types-row">
                        <div class="img">
                            ...
                            @php
                                $k = 'simpsons_on_paper_in_a_simple_frame';
                            @endphp
                            <picture>
                            @if(!empty($car[$k]['mob']['src_webp']))
                                <source media="(max-width: 576px)" srcset="{{ $car[$k]['mob']['src_webp'] }}" type="image/webp">
                        ...
                        <div class="img">
                            ...
                            @php
                                $k = 'simpsons_on_paper_in_a_premium_frame';
                            @endphp
                            <picture>
                            @if(!empty($car[$k]['mob']['src_webp']))
                                <source media="(max-width: 576px)" srcset="{{ $car[$k]['mob']['src_webp'] }}" type="image/webp">
...
<section class="example-section divider-container" id="examples">
    <div class="section-frame">
        <h2 class="page-title page-title_white "> @lang('simpson.examples_title') </h2>
        <div class="examples-wrap example-flex">
            <div class="before-after__block">
                ...
                <div class="ba-slider">
                    @if (!$ba_items->isEmpty())
                        <picture>
                            <img src="{{ $ba_items[0]->getUrl() }}" @altAttrs($item, "media:new_before_items", $ba_items[0]->getUrl(), null, $ba_items[0]->getCustomProperty("image_alt_" . app()->getLocale()), $ba_items[0]->getCustomProperty("image_title_" . app()->getLocale())) />
                        </picture>
                    @endif
                    @if (!$ba_items_after->isEmpty())
                        <div class="resize">
                            <picture>
                                <img srcset="{{ $ba_items_after[0]->getUrl() }}" @altAttrs($item, "media:new_after_items", $ba_items_after[0]->getUrl(), null, $ba_items_after[0]->getCustomProperty("image_alt_" . app()->getLocale()), $ba_items_after[0]->getCustomProperty("image_title_" . app()->getLocale())) />
                            </picture>
                        </div>
                    @endif
                                ...
                                <a class="examples-slide__photo">
                                    <picture>
                                        @if (isset($ba_items2[$loop->index]) && $ba_items2[$loop->index]->getUrl())
                                            <img src="{{ $ba_item->getUrl() }}" data-fancybox="group"
                                                data-src="{{ $ba_items2[$loop->index]->getUrl() }}" @altAttrs($item, "media:our_works_new", $ba_item->getUrl(), null, $ba_item->getCustomProperty("image_alt_" . app()->getLocale()), $ba_item->getCustomProperty("image_title_" . app()->getLocale()))
                                                loading="lazy" />
                                        @endif
                                    </picture>
                                </a>
    ...
    <div class="custom-shape-divider-bottom-1685740923" style="position: relative;">
                    ...
                    <div class="simpson-pattern__row">
                            ...
                            <div class="img">
                                ...
                                <picture>
                                    <source media="(max-width: 576px)"
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern1Min.webp') }}"
                                        type="image/webp">
                                    <source
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern1.webp') }}"
                                        type="image/webp">
                        ...
                        <div class="item">
                            <div class="img">
                                ...
                                <picture>
                                    <source media="(max-width: 576px)"
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern2Min.webp') }}"
                                        type="image/webp">
                                    <source
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern2.webp') }}"
                                        type="image/webp">
                        ...
                        <div class="item">
                            <div class="img">
                                ...
                                <picture>
                                    <source media="(max-width: 576px)"
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern3.webp') }}?v=1"
                                        type="image/webp">
                                    <source
                                        srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/s-pattern3.webp') }}?v=1"
                                        type="image/webp">
                    ...
                    @if (!$obrazy->isEmpty())
                        @foreach ($obrazy as $obraz)
                            <div class="portrait-list__item">
                                <p>{!! $obraz->custom_properties[$locale] !!} </p>
                                <div class="portrait-list__img">
                                    <img src="{{ $obraz->getUrl() }}" data-fancybox="group"
                                        data-src="{{ $obraz->getUrl() }}" @altAttrs($item, "media:reason_example", $obraz->getUrl(), null, $obraz->getCustomProperty("image_alt_" . app()->getLocale()), $obraz->getCustomProperty("image_title_" . app()->getLocale())) loading="lazy" />
                                    <a href="#simpsons-calc" attr_image="{{ $obraz->getUrl() }}" attr_type="obraz"
                                        onclick="$('input[name=obraz_img]').val('{{ $obraz->getUrl() }}'); $('input[name=obraz_title]').val('{{ trans('gallery.rep_style').':' }} #{{ strip_tags($obraz->custom_properties[$locale]) }}');"
                                        attr_name="{!! $obraz->custom_properties[$locale] !!}" class="yellow-btn js-simps-calc ">
                                        @lang('gallery.trybuy_btn')
                                    </a>
                                </div>
                            </div>
...
<section class="simpson-form">
    <div class="section-frame">
        <div class="section-inner">
            {{--                    <form action="{{ route('send_photo_portrait_form') }}" class="simpson-form__inner"> --}}
            <form data-portrait-by-photo-header="1" id="fastorder_form"
                action="{{ route('send_photo_portrait_form') }}" method="POST" enctype="multipart/form-data"
                class="vz-art popup-photo-canvas submit-form simpson-form__inner">
                ...
                <input type="hidden" id="new_styles" name="styles" value="Simpsons">
                <input type="hidden" id="new_count" name="count" name="styles" value="1">
                <input type="hidden" id="new_name" name="new_name" value="Simpsons">
...
@php
    /** @var \Illuminate\Support\Collection|SiteImage[] $siteImages */
    $siteImages = $siteImages ?? SiteImage::where('is_show', true)->get();
    $themePrefix = rtrim(config('theme.current'), '/');
    $publicPrefix = trim($themePrefix, '/');
    $giftBaseRel = $publicPrefix . '/images/sharj/new/simpson/';

    $giftFileVer = function (string $rel) {
        $full = public_path($rel);
        return file_exists($full) ? filemtime($full) : time();
    };

    $giftDeskItem = $siteImages->firstWhere('position_name', 'simpsons_gift');
    $giftMobItem  = $siteImages->firstWhere('position_name', 'simpsons_gift_mob');

    $deskWebpRel = $giftBaseRel . 'gift2.webp';
    $deskPngRel  = $giftBaseRel . 'gift2.png';

    $deskWebp = optional($giftDeskItem)->img_webp_url ?: asset($deskWebpRel);
    $deskPng  = optional($giftDeskItem)->img_url      ?: asset($deskPngRel);
    $deskV    = ($giftDeskItem && $giftDeskItem->updated_at) ? $giftDeskItem->updated_at->timestamp : $giftFileVer($deskWebpRel);

    $mobWebpRel = $giftBaseRel . 'gift2Min.webp';
    $mobPngRel  = $giftBaseRel . 'gift2Min.png';
    $mobWebpHas = file_exists(public_path($mobWebpRel));
    $mobPngHas  = file_exists(public_path($mobPngRel));

    $mobWebp = optional($giftMobItem)->img_webp_url ?: ($mobWebpHas ? asset($mobWebpRel) : $deskWebp);
    $mobPng  = optional($giftMobItem)->img_url      ?: ($mobPngHas  ? asset($mobPngRel)  : $deskPng);
    $mobV    = ($giftMobItem && $giftMobItem->updated_at)
        ? $giftMobItem->updated_at->timestamp
        : ($mobWebpHas ? $giftFileVer($mobWebpRel) : $deskV);

    $gift = [
        'desk' => ['webp' => $deskWebp, 'png' => $deskPng, 'v' => $deskV],
        'mob'  => ['webp' => $mobWebp,  'png' => $mobPng,  'v' => $mobV],
    ];
@endphp
        ...
        <div class="portrait-gift__grid">
            <div class="portrait-content">
                <div class="portrait-content__inner">
                    ...
                    <a href="#simpsons-calc" class="yellow-btn js-simps-calc">
                        @lang('simpson.yellow_btn')
                    </a>
                </div>
            ...
            <div class="portrait-img">
                <picture>
                    @if(!empty($gift['mob']['webp']))
                        <source media="(max-width: 576px)" srcset="{{ $gift['mob']['webp'] }}?v={{ $gift['mob']['v'] }}" type="image/webp">
                    @endif
                    @if(!empty($gift['mob']['png']))
                        <source media="(max-width: 576px)" srcset="{{ $gift['mob']['png'] }}?v={{ $gift['mob']['v'] }}" type="image/png">
                    @endif
                    @if(!empty($gift['desk']['webp']))
                        <source srcset="{{ $gift['desk']['webp'] }}?v={{ $gift['desk']['v'] }}" type="image/webp">
                    @endif
    ...
    <div class="section-frame">
        <div class="section-inner">
            <div class="title-row">
                ...
                <div class="steps-icons">
                    <picture>
                        <source media="(max-width: 576px)"
                            srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/stepsIcon1Min.webp') }}"
                            type="image/webp">
                        <source
                            srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/stepsIcon1.webp') }}"
                            type="image/webp">
                    ...
                    <picture>
                        <source media="(max-width: 576px)"
                            srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/stepsIcon2Min.webp') }}"
                            type="image/webp">
                        <source
                            srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/stepsIcon2.webp') }}"
                            type="image/webp">
            ...
            <div class="simpson-steps">
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask1Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask1.webp') }}"
                                type="image/webp">
                ...
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask2Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask2.webp') }}"
                                type="image/webp">
                            <img width="170" height="170"
                ...
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask3Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask3.webp') }}"
                                type="image/webp">
                            <img width="170" height="170"
                ...
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask4Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask4.webp') }}"
                                type="image/webp">
                            <img width="170" height="170"
                ...
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask5Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask5.webp') }}"
                                type="image/webp">
                            <img width="170" height="170"
                ...
                <div class="simpson-steps__item">
                    <div class="img">
                        <picture>
                            <source media="(max-width: 576px)"
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask6Min.webp') }}"
                                type="image/webp">
                            <source
                                srcset="{{ asset(config('theme.current') . '/images/sharj/new/simpson/mask6.webp') }}"
                                type="image/webp">
                            <img width="170" height="170"
            ...
            <div class="simpsons-calc">
                @include((config('theme.resource') ?: 'theme.viar.') . 'pages.simpsons.popup-order',['merchant'=>true])
            </div>
        </div>
        <div class="custom-shape-divider-bottom-1685740923">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                preserveAspectRatio="none">
                <path d="M600,112.77C268.63,112.77,0,65.52,0,7.23V120H1200V7.23C1200,65.52,931.37,112.77,600,112.77Z"
                    class="shape-fill shape-fill-white"></path>
            </svg>
    </div>
</section>
...
@php
    ...
    $themePrefix = rtrim(config('theme.current'), '/');
    $publicPrefix = trim($themePrefix, '/');
    $baseRel = $publicPrefix . '/images/sharj/new/';

    $fileVer = function (string $rel) {
        $full = public_path($rel);
        return file_exists($full) ? filemtime($full) : time();
    };
    ...
    for ($i = 1; $i <= 12; $i++) {
        $deskItem = $siteImages->firstWhere('position_name', "simpsons_service_{$i}");
        $mobItem  = $siteImages->firstWhere('position_name', "simpsons_service_{$i}_mob");

        $deskWebpRel = $baseRel . "service{$i}.webp";
        $deskPngRel  = $baseRel . "service{$i}.png";

        $deskWebp = optional($deskItem)->img_webp_url ?: asset($deskWebpRel);
        $deskPng  = optional($deskItem)->img_url      ?: asset($deskPngRel);
        $deskV    = ($deskItem && $deskItem->updated_at) ? $deskItem->updated_at->timestamp : $fileVer($deskWebpRel);

        $mobWebpRel = $baseRel . "service{$i}Min.webp";
        $mobPngRel  = $baseRel . "service{$i}Min.png";
        $mobWebpHas = file_exists(public_path($mobWebpRel));
        $mobPngHas  = file_exists(public_path($mobPngRel));

        $mobWebp = optional($mobItem)->img_webp_url ?: ($mobWebpHas ? asset($mobWebpRel) : $deskWebp);
        $mobPng  = optional($mobItem)->img_url      ?: ($mobPngHas  ? asset($mobPngRel)  : $deskPng);

        $mobV = ($mobItem && $mobItem->updated_at)
            ? $mobItem->updated_at->timestamp
            : ($mobWebpHas ? $fileVer($mobWebpRel) : $deskV);
                ...
                <div class="service-info__block">
                    ...
                    <div class="service-info__row">
                        <div class="image-group">
                            <picture>
                                @php $k = 1; @endphp
                                @if(!empty($services[$k]['mob']['webp']))
                                    <source media="(max-width: 576px)" srcset="{{ $services[$k]['mob']['webp'] }}?v={{ $services[$k]['mob']['v'] }}" type="image/webp">
                                @endif
                                @if(!empty($services[$k]['mob']['png']))
                                    <source media="(max-width: 576px)" srcset="{{ $services[$k]['mob']['png'] }}?v={{ $services[$k]['mob']['v'] }}" type="image/png">
                                @endif
                                @if(!empty($services[$k]['desk']['webp']))
                                    <source srcset="{{ $services[$k]['desk']['webp'] }}?v={{ $services[$k]['desk']['v'] }}" type="image/webp">
                                @endif
...
<div class="popup-wrapper">
    <div class="popup-item calculator-block image-calculator" style="display: block;">
        @include((config('theme.resource') ?: 'theme.viar.') . 'pages.simpsons.popup-order')
    </div>
    <div class="popup-layout"></div>
</div>

<h2 class="simpson-title">
    @lang('simpson.footer_h2') </h2>
