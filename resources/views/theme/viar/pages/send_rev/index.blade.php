								...
								<div class="r-img-wrap">
									<div class="r-img-t-row">
										<picture>
											<img width="50" height="50" src="{{ asset(config('theme.current') . '/images/review/client.svg') }}"
												 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/client.svg')), '', '')>
										</picture>
									...
									<picture>
										<img width="256" height="201" src="{{ asset(config('theme.current') . '/images/review/1.svg') }}"
											 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/1.svg')), '', '')>
									</picture>
								</div>
							</div>
						</div>
								...
								<div class="r-img-wrap">
									<picture>
										<img width="256" height="201" src="{{ asset(config('theme.current') . '/images/review/2.svg') }}"
											 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/2.svg')), '', '')>
									</picture>
								</div>
							</div>
						</div>
			...
			<div class="bonus__row">
				<div class="b-image">
					<img width="494" height="505" src="{{ asset(config('theme.current') . '/images/review/3.svg') }}"
						 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/3.svg')), '', '')>
				</div>
				<div class="b-soc">
					<a href="{{ setting('sots-seti.facebook') }}" class="b-soc-item" target="_blank">
						<img width="80" height="80" src="{{ asset(config('theme.current') . '/images/review/f.svg') }}"
							 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/f.svg')), '', '')>
					...
					<a href="{{ setting('sots-seti.google') }}" class="b-soc-item" target="_blank">
						<img width="80" height="80" src="{{ asset(config('theme.current') . '/images/review/g.svg') }}"
							 @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/g.svg')), '', '')>
						<p>@lang('pages.review_text18')</p>
					</a>
				</div>
				<div class="b-content">
...
<div class="ellipse ellipse_black ellipse_top">
	<img src="{{ asset(config('theme.current') . '/images/icon/ellipse-black.svg') }}"  loading="lazy" @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/icon/ellipse-black.svg')), 'img', '')>
</div>
	...
	<div class="section-frame">
		<div class="only__screen--inner">
			...
			<div class="only-row">
				<div class="only-item">
					<div class="o-box">
						<img src="{{ asset(config('theme.current') . '/images/review/o1.svg') }}"  @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/o1.svg')), '', '')>
					</div>
					<p>
				...
				<div class="only-item">
					<div class="o-box">
						<img src="{{ asset(config('theme.current') . '/images/review/o2.svg') }}"  @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/o2.svg')), '', '')>
					</div>
					<p>
				...
				<div class="only-item">
					<div class="o-box">
						<img src="{{ asset(config('theme.current') . '/images/review/o3.svg') }}"  @frontendAlt('theme/viar/pages/send_rev/index.blade.php', (asset(config('theme.current') . '/images/review/o3.svg')), '', '')>
					</div>
					<p>
