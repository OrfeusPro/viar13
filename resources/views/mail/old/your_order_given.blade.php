...
<body style="position:relative;margin: 0 auto;">
	...
	<table width="100%" cellpadding="0" cellspacing="0"
		style="display:block;max-width: 600px;margin: 0 auto;margin-bottom: 100px;font-family: 'Lato', sans-serif;max-width: 600px;position: relative;padding-left: 35px;padding-bottom: 50px;padding-top: 30px; border: 0;box-sizing: border-box; height: auto;background: url('<?php echo $base_url; ?>/letters/bg.png');background-repeat: no-repeat;background-size:100% 100%;padding-right: 20px;border-radius:19px;">
		<tr>
			<td>
		...
		<tr>
			<td>
				<h1 style="font-family:'Lato', sans-serif;font-size:30px;margin: 0;font-weight: 700;">
					<?php echo $trans['your_order_given']; ?> (#<?php echo $order_id; ?>)</h1>
			</td>
		</tr>
		<tr>
			<td style="font-size: 18px; font-weight: 900; color: #a0565f;">
				<?php echo $trans['your_order_given_foto']; ?>
			</td>
		</tr>
		<tr>
			<td>
				<span
					...
					<?php echo  $trans['your_order_z_data']; ?></span>
				<ul
					...
					<li style="display: list-item;list-style-position: outside;">
						...
						<?php echo $ts1['size_text']; ?>: <?php echo $product['sizeId']; ?>
						<?php } ?>

						<?php if(isset($product['size_name'])) { ?>
						<?php echo $ts1['size_text']; ?>: <?php echo $product['size_name']; ?>
						<?php } ?>
					</li>
