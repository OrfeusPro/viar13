...
<div class="ellipse ellipse_black">
    <img src="{{ asset(env('THEME').'images/icon/ellipse-black.svg') }}"  loading="lazy" @frontendAlt('partials/index_new/examples4.blade.php', (asset(env('THEME').'images/icon/ellipse-black.svg')), 'img', '')>
</div>
