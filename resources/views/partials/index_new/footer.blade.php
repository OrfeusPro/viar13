<footer class="vz-art vz-footer footer_index_new">
        <div class="section-frame">
            <div class="vz-art footer-bar">
                ...
                <div class="vz-art footer-list">
                    <h3><span class="vz-art faq-icon"></span> {{ trans('header_footer_new.footer_col1_name') }}</h3>
                    <ul>
                        @if ($menu_items1_bot)
                ...
                <div class="vz-art footer-list">
                    <h3><span class="vz-art faq-icon"></span> {{ trans('header_footer_new.footer_col2_name') }}</h3>
                    <ul>
                        @if ($menu_items2_bot)
                ...
                <div class="vz-art footer-list">
                    <h3><span class="vz-art faq-icon"></span> {{ trans('header_footer_new.footer_col3_name') }}</h3>
                    <ul>
                        @if ($menu_items3_bot)
        ...
        <div class="eraf">
            ...
            <div class="liaa-text"><span>{{ trans('header_footer_new.footer_copyright') }}</span>
            </div>
        </div>
