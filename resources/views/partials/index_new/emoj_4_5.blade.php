                    ...
                    <div class="stock-full stock-full_tablet">
                        @if (isset($bot_form_step1_default->image))
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('storage/' . $bot_form_step1_default->image) }}"
                                    data-stock="1" class="stock-photo lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('storage/' . $bot_form_step1_default->image)), 'img', '')>
                            </picture>
                        @endif
                        <!-- <picture>
                            <source srcset="{{ asset('images/kviz-full/kviz-2.webp') }}" type="image/webp">
                            <source srcset="{{ asset('images/kviz-full/kviz-2.jpg') }}" type="image/jpeg">
                            <img loading="lazy" src="{{ asset('images/kviz-full/kviz-2.jpg') }}" data-stock="2"
                        ...
                        <div class="stock-item">
                            ...
                            <picture>
                                ...
                                <img loading="lazy" class="lozad"
                                    src="{{ asset('images/kviz/kviz-1.png') }}"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-1.png')), 'img', '')>
                            </picture>
                        </div>
                        <div class="stock-item">
                            ...
                            <picture>
                                ...
                                <img loading="lazy" class="lozad"
                                    src="{{ asset('images/kviz/kviz-2.png') }}"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-2.png')), 'img', '')>
                            </picture>
                        </div>
                        <div class="stock-item">
                            ...
                            <picture>
                                ...
                                <img loading="lazy" class="lozad"
                                    src="{{ asset('images/kviz/kviz-3.png') }}"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-3.png')), 'img', '')>
                            </picture>
                        </div>
                    </div>
                </div>
                        ...
                        @if (isset($bot_form_step2_default->image))
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('storage/' . $bot_form_step2_default->image) }}"
                                    data-stock="2" class="stock-photo lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('storage/' . $bot_form_step2_default->image)), 'img', '')>
                            </picture>
                        @endif
                        <!-- <picture>
                            <source srcset="{{ asset('images/kviz-full/kviz-2.webp') }}" type="image/webp">
                            <source srcset="{{ asset('images/kviz-full/kviz-2.jpg') }}" type="image/jpeg">
                            <img loading="lazy" src="{{ asset('images/kviz-full/kviz-2.jpg') }}" data-stock="1"
                                class="stock-photo lozad" alt="img">
                        </picture> -->
                    </div>
                        ...
                        <div class="stock-item">
                            ...
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('images/kviz/kviz-1.png') }}"
                                    class="lozad" @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-1.png')), 'img', '')>
                            </picture>
                        </div>
                        <div class="stock-item">
                            <p>{!! $bot_form['f_banner_bot2'] !!}</p>
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('images/kviz/kviz-2.png') }}"
                                    class="lozad" @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-2.png')), 'img', '')>
                            </picture>
                        </div>
                        <div class="stock-item">
                            <p>{!! $bot_form['f_banner_bot3'] !!}</p>
                            <picture>
                                ...
                                <img loading="lazy" src="{{ asset('images/kviz/kviz-3.png') }}"
                                    class="lozad" @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz/kviz-3.png')), 'img', '')>
                            </picture>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="stock-full stock-full_tablet">
                        @if (isset($bot_form_step3_default->image))
                            <picture>
                                {{-- <source srcset="{{ asset('images/kviz-full/kviz-1.webp') }}" type="image/webp"> --}}
                                {{-- <source srcset="{{ asset('images/kviz-full/kviz-1.jpg') }}" type="image/jpeg"> --}}
                                <img loading="lazy" src="{{ asset('storage/' . $bot_form_step3_default->image) }}"
                                    data-stock="1" class="stock-photo lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('storage/' . $bot_form_step3_default->image)), 'img', '')>
                            </picture>
                        @endif
                        <!-- <picture>
                            <source srcset="{{ asset('images/kviz-full/kviz-2.webp') }}" type="image/webp">
                                            ...
                                            <div class="kviz-radio-descriptor">
                                                <picture>
                                                    ...
                                                    <img loading="lazy"
                                                        ...
                                                        class="lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz-full/kviz-1.jpg')), 'img', '')>
                                                </picture>
                    ...
                    <div class="stock-full">
                        ...
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('images/kviz-full/kviz-1.jpg') }}" data-stock="1"
                                class="stock-photo lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/kviz-full/kviz-1.jpg')), 'img', '')>
                        </picture>
                        <!-- <picture>
                            <source srcset="{{ asset('images/kviz-full/kviz-2.webp') }}" type="image/webp">
                            <source srcset="{{ asset('images/kviz-full/kviz-2.jpg') }}" type="image/jpeg">
            ...
            <div class="kviz-item" data-step="4">
                <picture>
                    ...
                    <img loading="lazy" src="{{ asset('images/bg/kviz-finish.png') }}" class="kviz-finsh-photo lozad"
                          @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/bg/kviz-finish.png')), 'img', '')>
                </picture>
                <div class="kviz-content">
                    <div class="kviz-step">
                            ...
                            <div class="form-send__item">
                                <div class="form-send__input-item">
                                    ...
                                    <img loading="lazy" src="{{ asset('img/icons/phone.svg') }}"
                                        class="img-svg img-svg__posa lozad" @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('img/icons/phone.svg')), '', '')>
                                </div>
                            </div>
                        </div>
                        <div class="kviz-input">
            ...
            <div class="kviz-item kviz-thanks__parent" data-step="5">
                <div class="kviz-thanks">
                    <img loading="lazy" src="{{ asset('images/icon/check-done.svg') }}"
                        class="kviz-thanks__icon lozad"  @frontendAlt('partials/index_new/emoj_4_5.blade.php', (asset('images/icon/check-done.svg')), 'img', '')>
                    <div class="kviz-thanks__title">
                        <h3>{!! $bot_form['succ_thx'] !!}</h3>
