    ...
    <div class="about-fit--block">
        ...
        <div class="fit-image--bg">
            <picture>
                ...
                <img src="{{ ver_asset('images/about-m1.png') }}"  @frontendAlt('partials/portrait_new/tabs/second.blade.php', (ver_asset('images/about-m1.png')), '', '')/>
            </picture>
        </div>
    </div>
        ...
        <div class="about-offer">
            ...
            <div class="offer-img">
                <picture>
                    ...
                    <img src="{{ ver_asset('images/fit-1.jpg') }}"  @frontendAlt('partials/portrait_new/tabs/second.blade.php', (ver_asset('images/fit-1.jpg')), '', '')/>
                </picture>
            </div>
        </div>
        <div class="about-offer">
            ...
            <div class="offer-img">
                <picture>
                    ...
                    <img src="{{ ver_asset('images/fit-2.jpg') }}"  @frontendAlt('partials/portrait_new/tabs/second.blade.php', (ver_asset('images/fit-2.jpg')), '', '')/>
                </picture>
            </div>
        </div>
        <div class="about-offer">
            ...
            <div class="offer-img">
                <picture>
                    ...
                    <img src="{{ ver_asset('images/fit-3.jpg') }}"  @frontendAlt('partials/portrait_new/tabs/second.blade.php', (ver_asset('images/fit-3.jpg')), '', '')/>
                </picture>
            </div>
        </div>
    </div>
