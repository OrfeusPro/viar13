                                ...
                                <label class="kv__h__item kviz-radio js_canvas_type_item js-checkbox @if($loop->iteration === 2) kviz-radio_active @endif"
                                    ...
                                    <div>
                                            <span>
                                              ...
                                              <img src="{{ asset('images/icon/info.svg') }}"  @frontendAlt('partials/portrait_new/form/canvas.blade.php', (asset('images/icon/info.svg')), '', '')/>
                                            </span>
                                        <input
    ...
    <div class="formalization-prompt">
        <div class="formalization-prompt--wrapper">
            <div class="formalization-prompt--inner">
                <img src="{{ asset('images/prompt5.png') }}"  @frontendAlt('partials/portrait_new/form/canvas.blade.php', (asset('images/prompt5.png')), '', '')/>
                <p>
