<div class="filter-interior tabs-item tabs-item2">
    <form>
                    ...
                    <div class="size-item">
                        ...
                        <div class="range__box" @if($loop->first) style="display:block;" @endif>
                            <input type="number"
                                ...
                                <div class="range_box">
                                    <input type="range" class="zoomRange range-input" id="my-range"
        ...
        <div class="total-price">
            ...
            <div class="sum">
            <h4 id="totalSum"><span data-total="{{ $mod_head['price'] }}" id="totalPrice">{{ $mod_head['price'] }}</span> &euro;</h4>
                    <div class="js_spinner"></div>
                </div>
            <a class="js_add_basket_module"
            data-title="{{  $mod_head['meta_title'] }}"
            href="javascript:void(0)"><span>{!!$int_globs['add_to_bask_title'] !!}</span></a>
            <ul>
