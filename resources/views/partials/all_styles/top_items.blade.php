        ...
        <a href="{{ $item['link'] }}">
            <div class="arts__image arts__image_vertical">
                ...
                <picture class="arts__product-image">
                    ...
                    @php
                        $topItemImageSources = !empty($item['image']) ? image_picture_sources('/storage/' . $item['image'], true) : null;
                    @endphp
                    @if(!empty($topItemImageSources['src_webp']))
                        <source srcset="{{ $topItemImageSources['src_webp'] }}" type="image/webp">
                    @endif
