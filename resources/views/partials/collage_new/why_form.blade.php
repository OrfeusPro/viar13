        <form action="{{ route('send_all_styles_form') }}" method="POST" enctype="multipart/form-data"
            class="why-form submit-form portait-why-form">
            @csrf
            <div class="f__errs">
                @if ($errors)
                    <ul>
                ...
                <div class="kviz-input">
                    ...
                    <div class="page-input__item phone-input">
                        <div class="banner__input-item">
                            ...
                            <img loading="lazy" src="{{ asset('img/icons/phone.svg') }}"  class="img-svg img-svg__posa" @frontendAlt('partials/collage_new/why_form.blade.php', (asset('img/icons/phone.svg')), '', '')>
                        </div>
                    </div>
                </div>
              <div class="kviz-input">
                <p class="kviz-input__title">{!! trans('collage_new.add_comment') !!}</p>
                <div class="page-input__item">
                ...
                <div class="kviz-input">
                    <p class="kviz-input__title">{!! trans('collage_new.foto') !!}</p>
                    <div class="file-save">
                            <div class="abs-close">
                                X
                            </div>
            ...
            <picture>
                ...
                <img src="{{ asset('images/pinned-photo.png') }}" class="why-form__photo"  loading="lazy" @frontendAlt('partials/collage_new/why_form.blade.php', (asset('images/pinned-photo.png')), 'img', '')>
            </picture>
        </form>
