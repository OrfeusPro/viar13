<script src="{{ asset(env('THEME').'js/collage-templates.js?v3') }}"></script>
<script src="{{ asset(env('THEME').'js/PhotoEditor.js') }}"></script>
...
<script>
  ...
  var templateAltAttributes = @json(app(\App\Services\AltGeneration\FrontendImageRegistry::class)->inlineAttributes('partials/collage_new/js.blade.php', 'theme/viar/js/collage-templates.js'));
