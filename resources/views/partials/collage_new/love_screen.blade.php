    ...
    <div class="ellipse el-desk ellipse-b-dbt">
        <img src="{{ asset('images/icon/ellipse-whete.svg') }}"  loading="eager"  @frontendAlt('partials/collage_new/love_screen.blade.php', (asset('images/icon/ellipse-whete.svg')), 'img', '')>
    </div>
                    ...
                    <div class="c-l-col">
                        ...
                        <div class="c-l-image">
                            <picture>
                                ...
                                <img loading="lazy" width="377" height="586" src="{{ asset('images/collage/11.jpg') }}"  @frontendAlt('partials/collage_new/love_screen.blade.php', (asset('images/collage/11.jpg')), '', '')>
                            </picture>
                        </div>
                    </div>
                    <div class="c-l-col">
                    ...
                    <div class="c-l-col">
                        <div class="c-l-image">
                            <picture>
                                ...
                                <img loading="lazy" width="377" height="586" src="{{ asset('images/collage/12.jpg') }}"  @frontendAlt('partials/collage_new/love_screen.blade.php', (asset('images/collage/12.jpg')), '', '')>
                            </picture>
                        </div>
                    </div>
    ...
    <div class="ellipse ellipse-b-ordbt">
        <img loading="lazy" src="{{ asset('images/collage/ellipse-orb.svg') }}"  loading="eager"  @frontendAlt('partials/collage_new/love_screen.blade.php', (asset('images/collage/ellipse-orb.svg')), 'img', '')>
    </div>
