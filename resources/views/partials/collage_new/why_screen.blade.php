            ...
            <div class="collage-why--inner">
                        ...
                        <a href="#generator" class="services-photo">
                            <picture>
								@if(Voyager::image($why_screen->image))
									{{--<source media="(max-width: 425px)" srcset="images/collage/1M.webp" type="image/webp">--}}
									<source media="(max-width: 425px)" srcset="{{Voyager::image($why_screen->image)}}" type="image/jpeg">
									{{--<source srcset="images/collage/1.webp" type="image/webp">--}}
                ...
                <a href="#" class="top-all hidden ">
                    <picture>
                        ...
                        <img src="{{ asset('./images/icon/load-more.png') }}"  loading="lazy" @frontendAlt('partials/collage_new/why_screen.blade.php', (asset('./images/icon/load-more.png')), 'img', '')>
                    </picture>
