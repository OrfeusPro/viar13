                                ...
                                >
                                    ...
                                    <div>
                                            <span>
                                              ...
                                              <img src="{{ asset('images/icon/info.svg') }}"  @frontendAlt('partials/simpsons/form/canvas.blade.php', (asset('images/icon/info.svg')), '', '')/>
                                            </span>
                                        <input
    ...
    <div class="formalization-prompt">
        <div class="formalization-prompt--wrapper">
            <div class="formalization-prompt--inner">
                <img src="{{ asset('images/prompt5.png') }}"  @frontendAlt('partials/simpsons/form/canvas.blade.php', (asset('images/prompt5.png')), '', '')/>
                <p>
