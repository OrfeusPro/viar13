                ...
                <div class="img">
                    <img
                        src="{{ asset('images/canvas/execution-item2.svg') }}"
                         @frontendAlt('partials/canvas_new/form/step4.blade.php', (asset('images/canvas/execution-item2.svg')), '', '')/>
                </div>
            </div>
                ...
                <div class="img">
                    ...
                    <img
                        src="{{ asset('images/canvas/execution-item1.svg') }}"
                         @frontendAlt('partials/canvas_new/form/step4.blade.php', (asset('images/canvas/execution-item1.svg')), '', '')/>
                </div>
            </div>
