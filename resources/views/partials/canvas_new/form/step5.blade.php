            ...
            <div class="kviz-radio js-checkbox kviz-radio_active"
                ...
                <label>
                                                <span>Эконом (плотность 280г/м2)
                                                  <img src="{{ asset('images/icon/info.svg') }}"  @frontendAlt('partials/canvas_new/form/step5.blade.php', (asset('images/icon/info.svg')), '', '')></span>
            ...
            <div class="kviz-radio js-checkbox" data-id="2"
                ...
                <label>
                                                <span>Интерьерный (плотность 500г/м2)
                                                  <img src="{{ asset('images/icon/info.svg') }}"  @frontendAlt('partials/canvas_new/form/step5.blade.php', (asset('images/icon/info.svg')), '', '')>
                                                </span>
            ...
            <div class="kviz-radio js-checkbox" data-id="3"
                ...
                <label>
                                                                                            <span>Синтетический (плотность 230г/м2)<img src="{{ asset('images/icon/info.svg') }}"
                                                                                                                                         @frontendAlt('partials/canvas_new/form/step5.blade.php', (asset('images/icon/info.svg')), '', '')></span>
