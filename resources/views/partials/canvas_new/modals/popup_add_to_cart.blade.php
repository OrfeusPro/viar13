            ...
            <div class="popup-cart--inner">
                <div class="cart-image">
                    ...
                    <picture>
                        ...
                        <img loading="lazy" src="{{ asset('images/canvas/canvas-popup.png') }}"  @frontendAlt('partials/canvas_new/modals/popup_add_to_cart.blade.php', (asset('images/canvas/canvas-popup.png')), '', '')>
                    </picture>
                </div>
