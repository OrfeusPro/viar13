    ...
    <div class="about-deadline">
        <div class="deadline-block">
            <div class="deadline-title">
                <img src="{{ ver_asset('images/clock.png') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/clock.png')), '', '')/>
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img src="{{ ver_asset('images/three-days.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/three-days.jpg')), '', '')/>
                        </picture>
                    </div>
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img src="{{ ver_asset('images/one-day.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/one-day.jpg')), '', '')/>
                        </picture>
                    </div>
                    <div class="deadline-content">
                        <div class="deadline-desc">
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img srcset="{{ ver_asset('images/on-date.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/on-date.jpg')), '', '')/>
                        </picture>
                    </div>
                    <div class="deadline-content">
                        <div class="deadline-desc">
        ...
        <div class="deadline-block">
            <div class="deadline-title">
                <img src="{{ ver_asset('images/delivery.png') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/delivery.png')), '', '')/>
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img src="{{ ver_asset('images/van.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/van.jpg')), '', '')/>
                        </picture>
                    </div>
                    <div class="deadline-content">
                        <div class="deadline-text">
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img src="{{ ver_asset('images/on-adress.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/on-adress.jpg')), '', '')/>
                        </picture>
                    </div>
                    <div class="deadline-content">
                        <div class="deadline-text">
                ...
                <div class="deadline-item">
                    <div class="deadline-img">
                        <picture>
                            ...
                            <img src="{{ ver_asset('images/abroad.jpg') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/abroad.jpg')), '', '')/>
                        </picture>
                    </div>
                    <div class="deadline-content">
                        <div class="deadline-text">
            ...
            <div class="courier-info">
                ...
                <div class="courier-items">
                    <div class="courier-item">
                        <div class="courier-inner">
                            <div class="courier-logo">
                                <img src="{{ ver_asset('images/venipak.png') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/venipak.png')), '', '')/>
                            </div>
                    ...
                    <div class="courier-item">
                        <div class="courier-inner">
                            <div class="courier-logo">
                                <img src="{{ ver_asset('images/dpd.png') }}"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/dpd.png')), '', '')/>
                                <img src="{{ ver_asset('images/omniva-logo-41B019A1E9-seeklogo.com.png') }}" style="max-width: 50px;"  @frontendAlt('partials/canvas_new/tabs/fifth.blade.php', (ver_asset('images/omniva-logo-41B019A1E9-seeklogo.com.png')), '', '')/>
                            </div>
                            <div class="courier-txt">
