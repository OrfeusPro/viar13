    ...
    <form>
        ...
        <div class="formalization__block--top">
            <div class="formalization__block--top-inner">
                <div class="vz-art page-c-title sharj-popup--title h2_old">
                            ...
                            <div class="gallery-photo">
                                <div class="photo-content">
                                    <div class="photo-filter">
                                        @include('partials.canvas_new.form.tab1')
                                        <style>
                                            .range__box {
                                                display: none;
                                            }
                                        </style>
                                        @include('partials.canvas_new.form.tab2')
                                    </div>
        ...
        @include('partials.canvas_new.form.final')
    </form>
</div>
