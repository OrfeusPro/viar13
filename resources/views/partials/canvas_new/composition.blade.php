<section class="composition__screen section-p" id="composition">
    ...
    <div class="composition-inner">
        <picture>
            ...
            <img src="{{ asset('images/canvas/composition.jpg') }}"  @frontendAlt('partials/canvas_new/composition.blade.php', (asset('images/canvas/composition.jpg')), '', '')>
        </picture>
                            ...
                            <div class="kviz-input">
                                ...
                                <div class="page-input__item phone-input">
                                    <div class="country-item country-item-active">
                                        <img src="{{ asset('images/flag/lv.svg') }}"  loading="lazy" @frontendAlt('partials/canvas_new/composition.blade.php', (asset('images/flag/lv.svg')), 'img', '')>
                                    </div>
                                    <div class="country-list">
										@foreach ($c_tels as $tel)
											<div class="country-item">
												<img src="{{ asset('images/flag') }}/{{ strtolower($tel['country_code']) }}.svg"
													loading="lazy"  @frontendAlt('partials/canvas_new/composition.blade.php', (asset('images/flag')) . '/' . (strtolower($tel['country_code'])) . '.svg', 'img', '')/>
