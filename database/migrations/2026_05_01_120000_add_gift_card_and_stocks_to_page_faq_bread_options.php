...
class AddGiftCardAndStocksToPageFaqBreadOptions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $details['options'] = array_merge($options, [
    ...
    public function down()
    {
        ...
        if (isset($details['options']) && is_array($details['options'])) {
            unset($details['options']['gift_card'], $details['options']['stocks']);
        }
