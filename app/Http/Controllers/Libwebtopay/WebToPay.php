 ...
 */
class WebToPay extends Controller{
    ...
    const PAYSERA_METHOD_KEY_ONLINE_PAYSERA = 'online_paysera';
    const PAYSERA_METHOD_KEY_CREDIT_CART    = 'creditcart';
    const PAYSERA_METHOD_KEY_GOOGLE_PAY     = 'google_pay';
    const PAYSERA_METHOD_KEY_APPLE_PAY      = 'apple_pay';

    const PAYSERA_METHODS_MAP = [
        self::PAYSERA_METHOD_KEY_ONLINE_PAYSERA => ['title' => 'cart_new.step_4_payment_by_card', 'title_translate' => true, 'img' => null],
        self::PAYSERA_METHOD_KEY_CREDIT_CART    => ['title' => 'cart_new.step_4_by_card_online', 'title_translate' => true, 'img' => 'img/cart/payments.png'],
        self::PAYSERA_METHOD_KEY_GOOGLE_PAY     => ['title' => 'Google Pay', 'title_translate' => false, 'img' => 'img/cart/pbl_ap.png'],
        self::PAYSERA_METHOD_KEY_APPLE_PAY      => ['title' => 'Apple Pay', 'title_translate' => false, 'img' => 'img/cart/pbl_jp.png'],
    ];
