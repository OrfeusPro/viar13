...
class PagePortraitRoyalController extends Controller
{
    const TYPE_ID = 1056;
    ...
    public function index(
      ...
      //  dd($h2_titles->other_work_h2);
        ...
        $content = view((config('theme.resource') ?: 'theme.viar.') . 'pages.portrait--royal')->with([
            'h2_titles'=>$h2_titles,
            'item' =>  $item,
            'revs' => $revs,
