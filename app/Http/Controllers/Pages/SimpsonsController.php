...
class SimpsonsController extends Controller
{
    ...
    public function index(
        ...
        $content = view(config('theme.resource') . 'pages.simpsons.index')->with([
            'item' =>  $item,
            'revs' => $revs,
            ...
            'top_form' => AllStyle::withTranslation(App::getLocale(), false)
                ->where('id', 1)->get()[0],
            'faqs' => PageFaq::where('page->simpsons', 'simpsons')->orderBy('sort', 'asc')->withTranslation(App::getLocale(), false)->get(),
