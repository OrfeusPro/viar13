 ...
 */
class PagePartnership extends Model
{
    use Translatable;

    protected $fillable = [];

    protected $table = 'page_partnership';

    protected $translatable = [
        'meta_title', 'meta_desc', 'title', 'top_text', 'partner_item_1', 'partner_item_2', 'partner_item_3',

        'sale_from', 'sale_after', 'sale_bot_text', 'sale_link_title', 'sale_link',
    ];
}
