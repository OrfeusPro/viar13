...
class AbandonedCartMailTwelve extends Mailable
{
    ...
    public function __construct(string $url_cart, string $url_checkout, AbandonedCart $cart, string $coupon = null)
    {
    ...
    public function build(): AbandonedCartMailTwelve
    {
        return $this->subject(__('mail.restore_basket_text11'))
            ->view('mail.abandoned_cart_24_hours');
    }
    ...
    private function processAttributes(AbandonedCart $cart)
    {
        ...
        try {
            ...
            Log::error('Ошибка преобразования корзины при отправке письма о забытой корзине с промокодом');
        }
        return $cartData;
    }
}
