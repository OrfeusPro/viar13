$(document).ready(function() {
    ...
    $(".tabs-item li").on("click", function() {
        ...
        $(".prices-slider").get(0).slick.setPosition(), b = 0;
    ...
    // $(".tabs-content .tabs-item>li").on("click", function(e) {
    //     e.preventDefault();
    //     var a = $(this).data("tads");
    //     $(".tabs-content .tabs-item li").removeClass("active");
    //     $(".tabs-container .tabs-item").removeClass("active");
    //     $(this).addClass("active");
    //     $("." + a).addClass("active");
    //     $(".tabs-work-slider").get(0).slick.setPosition();
    ...
    //             d = $(this).data("collapse"),
    //             e = $("." + d).height() + 100;
    //         $(".tabs-item").removeClass("open"), $(this).parent().addClass("open"), $(this).addClass("active"), $(c).animate({
    //             height: e
    //         }, 1e3, function() {}), $(this).find("span").text($(this).parent().data('show')), event.preventDefault();
    //         var f = $("." + d).offset().top - 100;
    //         $("body,html").animate({
    ...
    //             d = $(this).data("collapse"),
    //             e = $("." + d).height();
    //         $(".tabs-item").removeClass("open"), $(this).parent().removeClass("open"), $(this).removeClass("active"), $(c).animate({
    //             height: 467
    //         }, 1e3, function() {}), $(this).find("span").text($(this).parent().data('hide'));
    //         var f = $("body").offset().top;
    //         $("body,html").animate({
    //             scrollTop: f
    //         }, 1e3)
    ...
    // });
     ...
     $(".tabs-work-slider").slick({
    ...
    }), $(window).width() >= 1025 && $(".stages-items").slick("unslick"), $(".components-item .img").matchHeight({
        byRow: !1
        ...
        $(".portraits-item").removeClass("active"), $(this).addClass("active")
    }), $(".tabs-link .link li").on("click", function() {
        var a = $(this).data("item");
        $(".tabs-link .link li").removeClass("active"), $(".tabs-item").removeClass("active"), $(this).addClass("active"), $("." + a).addClass("active")
    })
