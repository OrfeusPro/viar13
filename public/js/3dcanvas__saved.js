...
Cell.prototype.h = function() //������
{
	return this.p2.y - this.p1.y;	
}

Cell.prototype.w = function()//������
{
	return this.p2.x - this.p1.x;		
}

Cell.prototype.anim = function()//���������� ��� ������������ ��������
{
	if (this.anim_old)
	{
...
Cell.prototype.BeginAnimation = function()//����������� �������� � ������
{
...
Cell.prototype.RectOut = function()//������� ������
{
	var r = {};	
	var anim = this.anim();
...
var PhotoEditor = function(options)
{
	...
	if (this.options.isAct_selection) this.initAction_selection();//�������������� ���������
	if (this.options.isAct_LayerOperations) this.initAction_LayerOperations();
	if (this.options.isAct_cellresize) this.initAction_cellresize();//�������������� ������������
	if (this.options.isAct_cellAdd) this.initAction_cellAdd();//�������������� ����������
	if (this.options.isAct_PhotoOperations) this.initAction_PhotoOperations();//��������������,�������� � ����, �������� ���� � ������,������� ������
...
PhotoEditor.prototype.getLineByPoint = function(point)
{
	...
	if (point.x > mn && point.y > mn && point.x < 1-mn && point.y < 1-mn)//�� ����������� ����� �������� � ���� 
	{
		
		var line,cell;
		
		this.grid.forEach(function(cell2){ //���� ����� � ����� ������ ������ 
			
				if (cell2.p1.x <= point.x && cell2.p2.x >= point.x)//��������� �� ����� ������ �� x
				{
				
				
					if (!line || ((cell2.p2.x - cell2.p1.x) > (line.p2.x - line.p1.x)))//���� ����� �� ���������� ��� ����� ������� ������
					{
						if (Math.abs(cell2.p1.y - point.y) < mn)//��������� ���������� �� ������ ����� � ����� 
						{   
							line = {};
...
function Canvas3D(canvas_ViewPort)
{
	...
	this.renderer = new THREE.WebGLRenderer({ antialias: true,canvas:canvas_ViewPort});
...
Canvas3D.prototype.BottomPanel = function()
{
...
Canvas3D.prototype.updata2DSize = function()
{
	...
	this.canvas.height = this.size_height * (ratio * 4);
	this.canvas.width = this.size_width * (ratio * 4);
}
...
Canvas3D.prototype.Box = function(size_width,size_height,size_depth)
{
	...
	const offset_x = (1 / (w+z)) * z;
	const offset_y = (1 / (h+z)) * z;
	...
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x,1 - offset_y),new THREE.Vector2(1 - offset_x,offset_y),new THREE.Vector2(offset_x ,offset_y)]); 	
			
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x,1 - offset_y),new THREE.Vector2(1 - offset_x,1 - offset_y),new THREE.Vector2(1 - offset_x ,offset_y)]);  
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(1 - offset_x,1 - offset_y),new THREE.Vector2(1,offset_y),new THREE.Vector2(1 - offset_x ,offset_y)]);  	
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(1 - offset_x,1 - offset_y),new THREE.Vector2(1,1 - offset_y),new THREE.Vector2(1,offset_y)]);  
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(0,1 - offset_y),new THREE.Vector2(offset_x ,offset_y),new THREE.Vector2(0 ,offset_y)]);  
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(0,1 - offset_y),new THREE.Vector2(offset_x,1 - offset_y),new THREE.Vector2(offset_x ,offset_y)]);  
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x ,offset_y),new THREE.Vector2(1 - offset_x,0),new THREE.Vector2(offset_x ,0)]); 
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x ,offset_y),new THREE.Vector2(1 - offset_x ,offset_y),new THREE.Vector2(1 - offset_x,0)]); 
	  
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x ,1),new THREE.Vector2(1 - offset_x,1 - offset_y),new THREE.Vector2(offset_x,1 - offset_y)]); 
     
	geometry.faceVertexUvs[0].push([new THREE.Vector2(offset_x ,1),new THREE.Vector2(1 - offset_x ,1),new THREE.Vector2(1 - offset_x,1 - offset_y)]); 
