$(document).ready(function () {
    ...
    $(".canvas-tabs .tabs-item li").on("click", function () {
        ...
        $(".canvas-tabs .tabs-item li").removeClass("active"),
            ...
            $(".height-content").animate({ height: 467 }, 1e3, function () {}),
            $(this).find("span").text($(this).find("span").data("show")),
            event.preventDefault();
        var c = $(this).data("tads"),
            d = $("." + c).offset().top - 100;

        if( $(".tabs-work-slider").length){
        ...
        $(".collapse").on("click", function () {
            if (0 == a()) {
                ...
                $(".tabs-item").removeClass("open"),
                    ...
                    $(this).addClass("active"),
                    $(c).animate({ height: e }, 1e3, function () {}),
                    $(this)
                        .find("span")
                        .text($(this).find("span").data("hide")),
                    event.preventDefault();
                var f = $("." + d).offset().top - 100;
                $("body,html").animate({ scrollTop: f }, 1e3);
            } else {
                (b = 0), console.log(b);
                var c = $(this).prev(),
                    d = $(this).data("collapse"),
                ...
                $(".tabs-item").removeClass("open"),
                    ...
                    $(c).animate({ height: 467 }, 1e3, function () {}),
                    $(this)
                        .find("span")
                        .text($(this).find("span").data("show"));
