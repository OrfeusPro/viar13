...
(function(){
    ...
    $('.interior-item').on('click', function(e){
        $(this).addClass('active');
        $(this).parent('.slick-slide').siblings().find('.interior-item').removeClass('active');
    });

    // 2

    // add image to interier
    $('.slider-tabs li a').on('click', function(e){
        var tab = $(this).data('tabs');
        var sz = $('.active.calcSize').data('size');
        var sizes = sz.split('x');

        editor.isOffset = false;
        canvas_img = editor.out(sizes[0]+00,sizes[1]+00, false);
        
        // if(tab == 'tabs-item2'){
        //     if(preview != undefined){   
        //         $('.tabs-item2').children('div').addClass('active');
        //         var img_movable = '<img style="" src="'+canvas_img+'">';
        //         $('.tabs-item2').find('.int-draggable').html(img_movable);
        //     }else{
        //         if(js_img_tab2 != ''){
        //             $('.tabs-item2').children('div').addClass('active');
        //             var img_movable = '<img style="" src="'+canvas_img+'">';
        ...
        //     saved_tab2_img = $('.int-draggable').children('img').attr('src');
    ...
    function setTemplates(format, selected){
        ...
        templates.forEach(function(tpl,i){
            ...
            var svg=$('<svg id="svg__mod_pic_gen" viewBox="0, 0, 100, '+modular[format]*100+'"/>');
    ...
    $('.interior-item').each(function(){
        ...
        $(this).click(function(){
            ...
            if(preview != undefined){   
                $('.tabs-item2').children('div').addClass('active');
                var img_movable = '<img style="" src="'+preview.src+'">';
                $('.tabs-item2').find('.int-draggable').html(img_movable);
            }
