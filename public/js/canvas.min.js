$(document).ready(function() {
    ...
    $(".tabs-work-slider").slick({
    ...
    }), $(window).width() >= 1025 && $(".stages-items").slick("unslick"), $(window).width() >= 768 && ($(".stages-item .img").matchHeight({
        byRow: !1
        ...
        byRow: !1
    })), jcf.replaceAll(), $(".jcf-fake-input").text("Загрузить фотографии"), $(".slider-tabs").on("click", "a", function() {
        var a = $(this).data("tabs");
        $(".slider-tabs a").removeClass("active"), $(this).addClass("active"), $(".gallery-photo .tabs-item").removeClass("active"), $("." + a).addClass("active"), $(".picture").get(0).slick.setPosition(), $(".interior-slider").get(0).slick.setPosition(), $(".ramu-slider").get(0).slick.setPosition(), $(".ramu-item .img").matchHeight({
            byRow: !1
        })
    }), $(".picture").slick({
        infinite: !0,
    ...
    }), $(".range-input").on("input", function() {}), $(".ramu-slider").slick({
        rows: 2,
        infinite: !0,
        slidesToShow: 3,
        slidesToScroll: 1,
        ...
        byRow: !1
    }), $(".product-download .jcf-button-content").text("Загрузить"), $(".imageFile").change(function() {
        $(".product-download .jcf-extension-png .jcf-button-content").text("+ Х")
    }), $(".product-download .img").matchHeight({
        byRow: !1
    })
}), $(window).resize(function() {
    $(window).width() >= 1025 && $(".stages-items").slick("unslick"), $(".product-download .img").matchHeight({
        byRow: !1
    })
});