...
(function(){
    ...
    function resizeCanvas(){
        svg0[0].setAttribute('id', 'svg__second_tab_image');
        svg0[0].setAttribute('xmlns', 'http://www.w3.org/2000/svg');
    ...
    function setTemplates(format, selected){
        ...
        templates.forEach(function(tpl,i){
            ...
            var svg=$('<svg id="svg__first_tab_image" data-index="'+ind+'" viewBox="0, 0, 100, '+modular[format]*100+'"/>');
